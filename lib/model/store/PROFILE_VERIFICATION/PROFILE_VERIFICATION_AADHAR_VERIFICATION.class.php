...
class PROFILE_VERIFICATION_AADHAR_VERIFICATION extends TABLE
{
    ...
    public function insertAadharDetails($profileId,$username,$date,$aadharId,$requestId)
    {
    	try
    	{
    		$sql = "INSERT IGNORE INTO PROFILE_VERIFICATION.AADHAR_VERIFICATION(PROFILEID,USERNAME,DATE,AADHAR_NO,REQUEST_ID) VALUES (:PROFILEID,:USERNAME,:DATE,:AADHARID,:REQUESTID) ON DUPLICATE KEY UPDATE AADHAR_NO=:AADHARID,REQUEST_ID=:REQUESTID";
