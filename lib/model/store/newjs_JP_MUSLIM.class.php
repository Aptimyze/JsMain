<?php
class NEWJS_JP_MUSLIM extends TABLE{
        ...
        public function getJpMuslim($pid)
        {
			try 
			{
				if($pid)
				{ 
					$sql="SELECT * FROM JP_MUSLIM WHERE PROFILEID=:PROFILEID";
		...
		public function update($pid,$paramArr=array())
		{
			...
			try {
				...
				$values=":PROFILEID ,";
					...
					$sqlUpdateReligion="Update JP_MUSLIM SET $updateStr where PROFILEID=:PROFILEID";
