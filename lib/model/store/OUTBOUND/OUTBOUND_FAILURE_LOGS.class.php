...
* 
*/
class OUTBOUND_FAILURE_LOGS extends AnotherClass
{
	/**
   * @fn __construct
  ...
  public function insertRecord($arrRecordData) {
    if (!is_array($arrRecordData))
      throw new jsException("", "Array is not passed in InsertRecord OF OUTBOUND_FAILURE_LOGS.class.php");
    ...
    try {
      ...
      $sql = "INSERT INTO OUTBOUND.FAILURE_LOGS ($szFields) VALUES ($szINs)";
