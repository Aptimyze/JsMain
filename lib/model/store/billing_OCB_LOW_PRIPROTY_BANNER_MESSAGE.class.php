<?php
class billing_OCB_LOW_PRIPROTY_BANNER_MESSAGE extends TABLE {
	...
	{
		try{
			$sql = "INSERT INTO billing.OCB_LOW_PRIPROTY_BANNER_MESSAGE(TOP_MSG,BOTTOM_MSG,START_DT,END_DT) VALUES (:TOP_MSG,:BOTTOM_MSG,:START_DT,:END_DT)";
	...
	{
		try{
			$sql = "SELECT TOP_MSG,BOTTOM_MSG,PAGEID FROM billing.OCB_LOW_PRIPROTY_BANNER_MESSAGE WHERE :TODAY_DATE BETWEEN START_DT AND END_DT";
			$prep = $this->db->prepare($sql);
