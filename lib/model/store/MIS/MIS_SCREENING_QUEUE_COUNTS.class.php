...
class MIS_SCREENING_QUEUE_COUNTS extends TABLE
{
	...
	public function insertRecord($arr,$hr,$date)
	{
		...
		try
		{
			$sql = "INSERT INTO MIS.SCREENING_QUEUE_COUNTS(`DATE` ,  `AT_HOUR` ,  `PROFILE_NEW` ,  `PROFILE_EDIT` ,  `PHOTO_ACCEPT_REJ_NEW` ,  `PHOTO_ACCEPT_REJ_EDIT` ,  `PHOTO_PROCESS_NEW` , `PHOTO_PROCESS_EDIT`) VALUES
