...
class MIS_EOI_DENIED_LOG extends TABLE
{
	...
	{  
		...
		try
		{
			...
			$sql="INSERT IGNORE INTO newjs.EOI_DENIED_LOG(VIEWER_PFID,VIEWED_PFID,DATE,GENDER,TYPE_BREACHED,TYPE_OF_USER) VALUES(:VIEWER_PFID,:VIEWED_PFID,:DATE,:GENDER,:TYPE_BREACHED,:TYPE_OF_USER)";
