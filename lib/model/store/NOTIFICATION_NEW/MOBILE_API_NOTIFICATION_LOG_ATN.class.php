...
class MOBILE_API_NOTIFICATION_LOG_ATN extends TABLE{
	...
	{
		$sqlInsert = "INSERT IGNORE INTO  $this->databaseName.NOTIFICATION_LOG_ATN (`PROFILEID`,`NOTIFICATION_KEY`,`MESSAGE_ID`,`SEND_DATE`,`SENT`,`OS_TYPE`) VALUES (:PROFILEID,:NOTIFICATION_KEY,:MESSAGE_ID,now(),:SENT,:OS_TYPE)";
        ...
        {
		try{
                	$sql = "SELECT PROFILEID FROM $this->databaseName.NOTIFICATION_LOG_ATN";
