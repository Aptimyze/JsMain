<?php
/*
 * This Class provide functions for profileInformation.ContactCenterAPP_CONFIG table
 * @author Reshu Rajput
 * @created 24 Sep 2013
*/

class ContactCenterAPP_CONFIG extends TABLE
{
	...
	*/
	...
	public function getConfig($fields="",$where=null)
	{
	   try
		...
		$sql = "SELECT $fields FROM profileInformation.ContactCenterAPP_CONFIG";
                if(is_array($where))
                {
			$sql.=" WHERE ";
			$size= sizeof($where);
