...
class PICTURE_PICTURE_API_RESPONSE extends TABLE {
  ...
  public function get($name)
  {
	  ...
	  $sql = "select p.id,N.MainPicUrl, p.PICTUREID,p.PROFILEID, p.ADULT,p.SPOOF,p.VIOLENCE,p.LABEL,p.FACE_COUNT from PICTURE.PICTURE_API_RESPONSE as p   JOIN newjs.PICTURE_FOR_SCREEN_NEW N ON N.PICTUREID = p.PICTUREID  WHERE  SCREEN IS NULL $str GROUP BY p.PICTUREID LIMIT 1";
