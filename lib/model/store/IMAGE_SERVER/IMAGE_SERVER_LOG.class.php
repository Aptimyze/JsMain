	...
	@param - total instance of the cron running, current instance, module name(PICTURE,SUCCESS etc),limit of result
        ...
        */
        public function fetchDataForCron($totalInstance,$currentInstance,$module,$limit)
        {
			...
			elseif($module == IMAGE_SERVER_MODULE_NAME_ENUM::getEnum("CRITICAL_INFO_DIVORCED_DOC"))
                                $sql = "SELECT I.AUTOID AS AUTOID,I.MODULE_NAME AS MODULE_NAME,I.MODULE_ID AS MODULE_ID,I.IMAGE_TYPE AS IMAGE_TYPE,I.STATUS AS STATUS,P.DOCUMENT_PATH AS DOCUMENT_PATH,P.PROFILEID AS PROFILEID FROM IMAGE_SERVER.LOG I LEFT JOIN newjs.CRITICAL_INFO_CHANGED_DOCS P ON I.MODULE_ID = P.ID WHERE I.STATUS = :STATUS AND I.MODULE_NAME = :MODULE_NAME AND I.AUTOID % :TOTAL_INSTANCE = :CURRENT_INSTANCE LIMIT :LIMIT";
            ...
            elseif($module == IMAGE_SERVER_MODULE_NAME_ENUM::getEnum("ABUSE_ATTACHMENTS")) {
              
              $sql =  <<<SQL
              SELECT I.AUTOID AS AUTOID,
              ...
              R.DOC_4 AS DOC_4,
              R.DOC_5 AS DOC_5
              FROM IMAGE_SERVER.LOG AS I 
              INNER JOIN feedback.ABUSE_ATTACHMENTS R 
              ON I.MODULE_ID = R.ID 
              WHERE I.STATUS = :STATUS AND
              I.MODULE_NAME = :MODULE_NAME AND
              I.AUTOID % :TOTAL_INSTANCE = :CURRENT_INSTANCE
              LIMIT :LIMIT
SQL;
