...
class billing_DISCOUNT_LOOKUP extends TABLE {
    ...
    {
        try{
            $sql = "SELECT SCORE_LOWER_LIMIT, SCORE_UPPER_LIMIT, GENDER, MTONGUE, SERVICE, 1_DISCOUNT, 2_DISCOUNT, 3_DISCOUNT, 6_DISCOUNT, 12_DISCOUNT, L_DISCOUNT FROM billing.DISCOUNT_LOOKUP";
		...
		$outputArr[$i]["1_DISCOUNT"] = $result["1_DISCOUNT"];
    ...
    public function insertData($params)
    {
        try{
            if(is_array($params) && $params){
                $sql = "INSERT INTO billing.DISCOUNT_LOOKUP (`SCORE_LOWER_LIMIT`, `SCORE_UPPER_LIMIT`, `GENDER`, `MTONGUE`, `SERVICE`,`1_DISCOUNT`,`2_DISCOUNT`, `3_DISCOUNT`, `6_DISCOUNT`, `12_DISCOUNT`, `L_DISCOUNT`) VALUES (:SCORE_LOWER_LIMIT, :SCORE_UPPER_LIMIT, :GENDER, :MTONGUE, :SERVICE, :1_DISCOUNT, :2_DISCOUNT, :3_DISCOUNT, :6_DISCOUNT, :12_DISCOUNT, :L_DISCOUNT)";
		...
		$res->bindValue(":1_DISCOUNT", $params["1_DISCOUNT"], PDO::PARAM_INT);
