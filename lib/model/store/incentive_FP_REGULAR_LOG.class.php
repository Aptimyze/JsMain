	...
	public function insertCount($date,$filter,$filteredProfiles=0,$count=0,$max_dt,$latest_reg_filtered=0,$latest_reg_cnt=0, $process)
        {
                try
                {
                        $sql = "REPLACE INTO incentive.FP_REGULAR_LOG (DATE,FILTER,FILTERED_PROFILES,COUNT,LATEST_REG_DT,LATEST_REG_FILTERED_PROFILES,LATEST_REG_COUNT, PROCESS) VALUES(:DATE,:FILTER,:FILTERED_PROFILES,:COUNT,:LATEST_REG_DT,:LATEST_REG_FILTERED_PROFILES,:LATEST_REG_COUNT,:PROCESS)";
