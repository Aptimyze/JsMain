...
class MOBILE_API_IOS_RESPONSE_LOG extends TABLE{
	...
	// get Data Count 
        ...
        {
                try{
                        $sql = "SELECT count(PROFILEID) count, NOTIFICATION_KEY FROM MOBILE_API.`IOS_RESPONSE_LOG` WHERE SEND_DATE>=:START_DATE AND SEND_DATE<=:END_DATE GROUP BY NOTIFICATION_KEY";
