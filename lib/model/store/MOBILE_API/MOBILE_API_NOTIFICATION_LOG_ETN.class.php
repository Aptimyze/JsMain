...
class MOBILE_API_NOTIFICATION_LOG_ETN extends TABLE{
	...
	{
		$sqlInsert = "INSERT IGNORE INTO  MOBILE_API.NOTIFICATION_LOG_ETN (`PROFILEID`,`NOTIFICATION_KEY`,`MESSAGE_ID`,`SEND_DATE`,`SENT`,`OS_TYPE`) VALUES (:PROFILEID,:NOTIFICATION_KEY,:MESSAGE_ID,now(),:SENT,:OS_TYPE)";
	...
	public function getNotificationProfiles()
        {
                try{
                        $sql = "SELECT PROFILEID FROM MOBILE_API.NOTIFICATION_LOG_ETN";
