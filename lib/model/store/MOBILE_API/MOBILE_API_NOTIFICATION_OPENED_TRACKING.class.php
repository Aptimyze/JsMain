...
class MOBILE_API_NOTIFICATION_OPENED_TRACKING extends TABLE{
    ...
    */
    public function insertEntry($params)
    {
		...
		{
			if(is_array($params)){
				$sql = "INSERT INTO MOBILE_API.NOTIFICATION_OPENED_TRACKING (PROFILEID,MESSAGE_ID, NOTIFICATION_KEY,CHANNEL,CLICKED_DATE) VALUES (:PROFILEID,:MESSAGE_ID, :NOTIFICATION_KEY,:CHANNEL,:CLICKED_DATE)";
