...
class MOBILE_API_NOTIFICATION_OPENED_TRACKING extends TABLE{
    ...
    */
    public function insertEntry($params)
    {
		...
		{
			if(is_array($params)){
				$sql = "INSERT IGNORE INTO MOBILE_API.NOTIFICATION_OPENED_TRACKING (MESSAGE_ID, NOTIFICATION_KEY,CHANNEL,CLICKED_DATE) VALUES (:MESSAGE_ID, :NOTIFICATION_KEY,:CHANNEL,:CLICKED_DATE)";
