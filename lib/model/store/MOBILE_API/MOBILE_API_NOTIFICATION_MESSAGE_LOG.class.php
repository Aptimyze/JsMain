...
class MOBILE_API_NOTIFICATION_MESSAGE_LOG extends TABLE
{
    ...
    public function insert($key, $msgId, $message, $title)
    {
        ...
        $sqlInsert = "INSERT IGNORE INTO  MOBILE_API.NOTIFICATION_MESSAGE_LOG (`NOTIFICATION_KEY` ,`MESSAGE_ID`,`MESSAGE`,`TITLE`,`ENTRY_DT`) VALUES (:NOTIFICATION_KEY,:MESSAGE_ID,:MESSAGE,:TITLE,:ENTRY_DT)";
