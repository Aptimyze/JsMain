...
class REGISTRATION_QUALITY extends TABLE
{
  ...
  public function __construct($dbname="")
  {
          ...
          $this->fields = "`REG_DATE` , `SOURCEID`, `SOURCECITY` , `TOTAL_REG` , `F22` , `F22MV` , `F22MVCC` , `M26` , `M26MV` , `M26MVCC` , `SCREENED_SIC`";
  }
        ...
        foreach ($registrationData as $key => $regCityData){
                foreach ($regCityData as $sourceGroup => $regDateData) {
                    ...
                    for($i = 1;$i<=$countReg;$i++){
                      $param[] = "(:REG_DATE_".$i.", :SOURCEID_".$i.", :SOURCECITY_".$i.", :TOTAL_REG_".$i.", :F22_".$i.", :F22MV_".$i.", :F22MVCC_".$i.", :M26_".$i.", :M26MV_".$i.", :M26MVCC_".$i.", :SCREENED_SIC_".$i.")";
                    }
