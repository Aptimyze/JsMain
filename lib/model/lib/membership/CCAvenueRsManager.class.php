<?php
class CCAvenueRsManager
{
    public static function getChecksum($MerchantId, $Amount, $OrderId, $URL, $WorkingKey) {
    ...
    public static function verifychecksum($MerchantId, $OrderId, $Amount, $AuthDesc, $CheckSum, $WorkingKey) {
