<?php
class RegEditPageForm extends sfForm
{
	private $page_obj;
	public $formValues;
	...
	public function configure()
	{
	  ...
	  foreach($fields as $field){
		  ...
		  if($request)
			$validators[strtolower($field->getNAME())]=jsValidatorsFactory::getValidatorObj($field,$request->getParameter('registrationData'),$page);
		  else
			$validators[strtolower($field->getNAME())]=jsValidatorsFactory::getValidatorObj($field,"",$page);
	  }
