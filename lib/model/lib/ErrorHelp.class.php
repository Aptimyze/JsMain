...
class ErrorHelp{
		...
		public static $ERR_REQUIRED = array('email'=>'Please provide an email.','password'=>'Please provide a password.','relationship'=>'Please choose the person for whom you are looking for.','gender'=>'Please provide a gender.','mtongue'=>'Please provide a mother tongue.','height'=>'Please provide a height.','mstatus'=>'Please provide your marital status.','religion'=>'Please provide a Religion.','city_res'=>'Please provide a city.','havechild'=>'Please provide Have Children.','dtofbirth'=>'Please provide Date of Birth.','caste'=>'Please provide a caste.','edu_level_new'=>' Please provide a degree.','occupation'=>'Please provide a work area.','income'=>'Please provide a income range.','yourinfo'=>'For the benefit of your matches, please write about yourself in at least 100 letters','P_LHEIGHT'=>'Please provide a low height.','P_HHEIGHT'=>'Please provide a high height.','name_of_user'=>'Please provide the name of the person for whom the profile is being created');
