...
JSMS_ACTION1=>"/",
JSMS_ACTION2=>"/",
TEXT=>"Your current city is mentioned as 'Others' on your profile. To get more responses, please update the State and City of your residence (you can still select 'City' as 'Others').",
SUBTEXT=>"This will help us in providing you more and better matches.",
BUTTON1_URL_IOS=>"common/criticalActionLayerTracking?layerR=$layerid&button=B1",
BUTTON1_URL_ANDROID=>"/common/criticalActionLayerTracking?layerR=$layerid&button=B1",
BUTTON2_URL_IOS=>"common/criticalActionLayerTracking?layerR=$layerid&button=B2",
