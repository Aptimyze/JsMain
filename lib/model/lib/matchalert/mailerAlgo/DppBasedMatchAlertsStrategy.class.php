...
class DppBasedMatchAlertsStrategy extends MatchAlertsStrategy {
         ...
         * @return array 
         */
        public function getMatches($returnTotalCount = '',$returnTotalCountWithCluster = 0) {
         ...
         */
        private function getSearchResult($SearchServiceObj, $SearchUtilityObj, $returnTotalCount = '',$clustersToShow = array()) {
                $SearchServiceObj->setSearchSortLogic($this->searchObj, $this->loggedInProfileObj, "", "");
                $SearchUtilityObj->removeProfileFromSearch($this->searchObj, 'spaceSeperator', $this->loggedInProfileObj, '', "", $this->removeMatchAlerts,'',1);
