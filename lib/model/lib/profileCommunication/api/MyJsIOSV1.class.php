...
class MyJsIOSV1 extends MyJsMobileAppV1
{
	static public function init()
		...
		self::$informationTupleFields= Array(
			...
			"MATCH_ALERT"=>Array("PROFILECHECKSUM","OCCUPATION","AGE", "HEIGHT", "RELIGION","CASTE","MTONGUE","INCOME","ProfilePic120Url","EDUCATION","USERNAME"));
		self::$informationTypeFields= Array(
			...
			"VISITORS"=>Array("NEW_COUNT","TITLE","TUPLES","TRACKING","CONTACT_ID"),
			"MATCH_ALERT"=>Array("TITLE","TUPLES","MY_MATCHES_FLAG","TRACKING","SHOW_NEXT","NEW_COUNT","CONTACT_ID","VIEW_ALL_COUNT"),
