...
class ContactEngineInterestViewedTuple extends Tuple {
    ...
    static public function init() {
        self::$fields =Array("USERNAME", "GENDER", "AGE", "HEIGHT", "RELIGION", "MTONGUE", "OCCUPATION", "HAVEPHOTO", "PHOTO_DISPLAY", "CASTE", "INCOME", "CITY", "IS_ALBUM", "SUBSCRIPTION","ACTIVATED","IS_ALBUM_TEXT","SearchPicUrl","edu_level_new","MOBPHOTOSIZE","INTEREST_VIEWED_DATE","SENT_MESSAGE","NATIVE_CITY","NAME_OF_USER");
    }
