...
class ViewSimilarEOITuple extends Tuple {
    ...
    static public function init() {
        self::$fields =Array("USERNAME", "PROFILEID", "IS_ALBUM","GENDER", "AGE", "HEIGHT", "RELIGION", "MTONGUE", "OCCUPATION", "CASTE", "INCOME", "CITY_RES", "EDU_LEVEL_NEW", "HAVEPHOTO", "PHOTO_DISPLAY", "IS_PHOTO_REQUESTED", "PROFILECHECKSUM", "LAST_LOGIN_DT", "IS_BOOKMARKED","edu_level_new");
    }
