...
class SearchConfig
{
	...
	public static $profilesOnMyjsOnApp = 20;
	...
	public static $allLabel = 'All';
        public static $anyWellKnownClg = 'Any Well Known College';
	...
	*/
		...
		//need to remove one of them
			...
			"KEYWORD_TYPE" => "keyword_type",
                        ...
                        "KNOWN_COLLEGE" => "wellKnownColleges"
                      );
