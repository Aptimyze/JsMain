...
class SearchConfig
{
	...
	*/
	...
	/* For Search UI */
        public static $searchDisplayFields = 'HEIGHT,USERNAME,PROFILEID,RELIGION,CASTE,MTONGUE,EDU_LEVEL_NEW,INCOME,OCCUPATION,AGE,LAST_LOGIN_DT,ENTRY_DT,SUBSCRIPTION,CITY_RES,COUNTRY_RES,MSTATUS,NATIVE_CITY,NATIVE_STATE';
