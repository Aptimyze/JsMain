                ...
                if(!empty($setOrCond)){
                        if(isset($setOrCond["CITY_RES"]) && isset($setOrCond["COUNTRY_RES"])){ 
                                ...
                                if($solrFormatValueCityIndia){
                                        $this->filters[]="&fq={!tag=country_res,city_res,city_india,state}CITY_RES:($solrFormatValueCityIndia) $searchOperator  COUNTRY_RES:($solrFormatValueCOUNTRY)";
                                        $this->filters[]="&fq={!tag=country_res,city_res,city_india,state}CITY_INDIA:($solrFormatValueCityIndia) $searchOperator  COUNTRY_RES:($solrFormatValueCOUNTRY)";
                                }else
