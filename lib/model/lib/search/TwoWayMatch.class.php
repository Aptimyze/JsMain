...
class TwoWayMatch extends SearchParamters
{
	...
	private $forwardParamsMaleLoggedIn = array('GENDER','LHEIGHT','HHEIGHT','LAGE','HAGE','MSTATUS','COUNTRY_RES','CITY_RES','DIET','SMOKE','DRINK','HANDICAPPED','NATURE_HANDICAP','CASTE','RELIGION','MTONGUE','MANGLIK','OCCUPATION','OCCUPATION_GROUPING','EDU_LEVEL_NEW');
