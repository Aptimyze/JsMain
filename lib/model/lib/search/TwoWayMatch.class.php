...
class TwoWayMatch extends SearchParamters
{
	...
	private $forwardParamsFemaleLoggedIn = array('GENDER','LHEIGHT','HHEIGHT','LAGE','HAGE','MSTATUS','COUNTRY_RES','CITY_RES','CITY_INDIA','DIET','SMOKE','DRINK','HANDICAPPED','NATURE_HANDICAP','CASTE','RELIGION','MTONGUE','MANGLIK','OCCUPATION','OCCUPATION_GROUPING','INCOME','EDU_LEVEL_NEW');
	private $forwardParamsMaleLoggedIn = array('GENDER','LHEIGHT','HHEIGHT','LAGE','HAGE','MSTATUS','COUNTRY_RES','CITY_RES','CITY_INDIA','DIET','SMOKE','DRINK','HANDICAPPED','NATURE_HANDICAP','CASTE','RELIGION','MTONGUE','MANGLIK','OCCUPATION','OCCUPATION_GROUPING','EDU_LEVEL_NEW');

	private $reverseParamsFemaleLoggedIn = array('PARTNER_MSTATUS','PARTNER_COUNTRYRES','PARTNER_HANDICAPPED','PARTNER_RELIGION','PARTNER_CASTE','LPARTNER_LAGE','HPARTNER_LAGE','LPARTNER_HAGE','HPARTNER_HAGE','LPARTNER_LHEIGHT','HPARTNER_LHEIGHT','LPARTNER_HHEIGHT','HPARTNER_HHEIGHT','PARTNER_ELEVEL_NEW','PARTNER_MANGLIK');
	private $reverseParamsMaleLoggedIn = array('PARTNER_MSTATUS','PARTNER_COUNTRYRES','PARTNER_HANDICAPPED','PARTNER_RELIGION','PARTNER_CASTE','LPARTNER_LAGE','HPARTNER_LAGE','LPARTNER_HAGE','HPARTNER_HAGE','LPARTNER_LHEIGHT','HPARTNER_LHEIGHT','LPARTNER_HHEIGHT','HPARTNER_HHEIGHT','PARTNER_INCOME','PARTNER_MANGLIK');
