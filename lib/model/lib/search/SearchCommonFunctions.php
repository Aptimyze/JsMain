...
class SearchCommonFunctions
{
	...
	*/
	public static function getMyDppMatches($sort="",$loggedInProfileObj='',$limit='',$currentPage="",$paramArr='',$removeMatchAlerts="",$dontShowFilteredProfiles="",$twoWayMatches='',$clustersToShow='')
	{
                $searchEngine = 'solr';
                $outputFormat = 'array';
