...
class SearchCommonFunctions
{
	...
	*/
	public static function getMyDppMatches($sort="",$loggedInProfileObj='',$limit='',$currentPage="",$paramArr='',$removeMatchAlerts="",$dontShowFilteredProfiles="",$twoWayMatches='',$clustersToShow='',$results_orAnd_cluster='',$notInProfiles='',$completeResponse)
	{
                $searchEngine = 'solr';
                $outputFormat = 'array';
