...
class CampaignsRegistrationMis
{
	...
	public function organiseRegistrationData($dataArr)
	{
		...
		{
                        $dataArr[$key]["QUALITY"] = "Y";
                        $dataArr[$key]["CLICK_URL"] = "CLICK_URL";
	...
	{
		$csvData = '';
                $iterate = "PROFILEID,ENTRY_DT,MTONGUE,RELIGION,CASTE,OCCUPATION,EDU_LEVEL_NEW,INCOME,RELATION,GENDER,AGE,COUNTRY_RES,STATE,CITY_RES,CASTE,CLICK_URL,CAMPAIGN,ADGROUP,SOURCE,MEDIUM,CAMPAIGN,ADNAME,KEYWORD,GROUPNAME,INCOMPLETE,ACTIVATED_STATUS,QUALITY,CHANNEL,PHOTO_UPLOADED,PCS,IS_PAID";
