...
class CampaignsRegistrationMis
{
	...
	{
		$csvData = '';
                $iterate = "PROFILEID,ENTRY_DT,MTONGUE,RELIGION,CASTE,OCCUPATION,EDU_LEVEL_NEW,INCOME,RELATION,GENDER,AGE,COUNTRY_RES,STATE,CITY_RES,CAMPAIGN,ADGROUP,SOURCE,MEDIUM,CAMPAIGN,ADNAME,KEYWORD,GCLID,GROUPNAME,INCOMPLETE,ACTIVATED_STATUS,IS_QUALITY,CHANNEL,PHOTO_UPLOADED,PCS,IS_PAID";
                $csvData .= "Profile ID,Registration Date,Mother Tongue,Religion,Caste,Occupation,Highest Degree,Income,Posted by,Gender,Age,Country,State,City,Campaign ID,Adgroup ID,source ID,utm_medium,utm_campaign,utm_term,Keyword,Gclid,Source Group Name,Incomplete (Y/N),Activated within 3 days (Y/H/N/D),Quality (Y/N),Device (Mobile/Desktop),Photo uploaded (Y- (0-20)/N),Profile Completion Score,Conversion (30 day)"."\n";
