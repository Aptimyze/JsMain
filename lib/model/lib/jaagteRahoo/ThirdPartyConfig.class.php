...
class ThirdPartyConfig
{
        ...
        static private function initConfig()
        {
                ...
                self::$SOLR["IP"]["SOLR-66"]= "http://10.10.18.66:8983/solr/techproducts/select";
                ...
                self::$PRESENCE["IP"]["PRESENCE_67"]= "http://10.10.18.67:8290";
                self::$PRESENCE["IP"]["PRESENCE_72"]= "http://10.10.18.72:8290";
                self::$PRESENCE["URL"]="/profile/v1/presence";
