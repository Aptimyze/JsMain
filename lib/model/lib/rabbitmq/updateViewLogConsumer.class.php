...
class updateViewLogConsumer
{
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::VIEW_LOG, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      switch($process)
      {
        case 'ViewLogQueue':$handlerObj->updateViewLogTable($body,$type);
            break;
      }     
    }
    catch (Exception $exception) 
