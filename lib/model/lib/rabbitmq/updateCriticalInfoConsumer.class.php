...
*/
class updateCriticalInfoConsumer
{
  private $connection;
  private $channel;
  ...
  */
  public function __construct($serverid,$messsageCount)
  {
    ...
    catch (Exception $exception) 
    {
      ...
      RabbitmqHelper::sendAlert($str,"updateCriticalInfo");
    }
    try
    {
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_CRITICAL_INFO_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      $handlerObj->updateCriticalInfo($body);
    }
    catch (Exception $exception) 
    {
