...
*/
class updateFeaturedProfileConsumer
{
  private $connection;
  private $channel;
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_FEATURED_PROFILE_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
	...
	case 'UPDATE_FEATURED_PROFILE':
	  $handlerObj->updateFeaturedProfile($type,$body);
            break;
      }     
    }
    catch (Exception $exception) 
