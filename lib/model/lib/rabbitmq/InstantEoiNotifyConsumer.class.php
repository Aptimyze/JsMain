...
*/
class InstantEoiNotifyConsumer
{
  private $connection;
  private $channel;
  ...
  /**
   * 
   * Constructor for instantiating object of instant Eoi notification consumer class
   * 
   * <p>
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::INSTANT_EOI_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
