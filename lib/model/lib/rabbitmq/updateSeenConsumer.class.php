...
class updateSeenConsumer
{
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_SEEN_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      {
	case 'UPDATE_SEEN':
	  $handlerObj->updateSeen($type,$body);
            break;
      }     
    }
    catch (Exception $exception) 
