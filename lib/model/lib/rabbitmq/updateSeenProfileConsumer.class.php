...
*/
class updateSeenProfileConsumer
{
  private $connection;
  private $channel;
  ...
  */
  public function __construct($serverid,$messsageCount)
  {
    ...
    catch (Exception $exception) 
    {
      ...
      RabbitmqHelper::sendAlert($str,"updateSeenProfile");
    }
    try
    {
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_SEEN_PROFILE_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      $handlerObj->updateSeenProfile($type,$body);
    }
    catch (Exception $exception) 
    {
