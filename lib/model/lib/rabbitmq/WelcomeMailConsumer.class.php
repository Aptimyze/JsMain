...
class WelcomeMailConsumer {
    ...
    public function receiveMessage() {
        ...
        try {
            $this->channel->basic_consume(MQ::EXCLUSIVE_MAIL_SENDING_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK, MQ::CONSUMER_EXCLUSIVE, MQ::NO_WAIT, array($this, 'processMessage'));
        } catch (Exception $exception) {
