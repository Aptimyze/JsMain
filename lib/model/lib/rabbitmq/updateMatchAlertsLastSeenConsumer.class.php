...
*/
class updateMatchAlertsLastSeenConsumer
{
  private $connection;
  private $channel;
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_MATCHALERTS_LAST_SEEN_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      $handlerObj->updateMatchAlertsLaseSeen($body);
    }
    catch (Exception $exception) 
    {
      $codeException = 1;
