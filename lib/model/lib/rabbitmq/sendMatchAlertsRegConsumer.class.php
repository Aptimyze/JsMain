...
*/
class sendMatchAlertsRegConsumer
{
  private $connection;
  private $channel;
  ...
  */
  public function __construct($serverid,$messsageCount)
  {
    ...
    catch (Exception $exception) 
    {
      ...
      RabbitmqHelper::sendAlert($str,"sendMatchAlertsRegConsumer");
    }
    try
    {
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::UPDATE_MATCHALERTS_REG_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
    }
    catch (Exception $exception) 
    {
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      $handlerObj->sendMatchAlertsReg($body);
    }
    catch (Exception $exception) 
    {
