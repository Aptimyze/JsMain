...
class chatMessageConsumer
{
	...
	public function receiveMessage()
	{
		...
		try
		{
			$this->channel->basic_consume(MQ::CHAT_MESSAGE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
	...
	public function processMessage(AMQPMessage $msg)
	{
		...
		try
		{
			...
			{
				case 'CHATMESSAGE':
					$handlerObj->insertChatMessage($type,$body);
					break;
			}
		}
		catch (Exception $exception)
