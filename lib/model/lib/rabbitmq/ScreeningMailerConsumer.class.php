...
class ScreeningMailerConsumer
{
  ...
  */
  ...
  {   
    ...
    try
    {
      $this->channel->basic_consume(MQ::SCREENING_MAILER_QUEUE, MQ::CONSUMER, MQ::NO_LOCAL, MQ::NO_ACK,MQ::CONSUMER_EXCLUSIVE , MQ::NO_WAIT, array($this, 'processMessage'));
  ...
  public function processMessage(AMQPMessage $msg)
  {
    ...
    try
    {
      ...
      switch($process)
      {
        case MQ::SCREENING_MAILER : CommonFunction::sendWelcomeMailer($body['profileId']);
            break;
      }     
    }
    catch (Exception $exception) 
