...
class crmParams
{
	...
	public static $salesRegularCampaign		=array("1"=>"noida","2"=>"mumbai","3"=>"pune","4"=>"nri","5"=>"delhi","6"=>"noidaNew");
	public static $salescampaignNames		=array('noida'=>'JS_NCRNEW','mumbai'=>'JS_MAHNEW','noidaNew'=>'JS_NCRNEW_Auto');
