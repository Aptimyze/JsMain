...
{	
  ...
  const MUSLIM_NAME = "Muslim";
        ...
        public static $sendInstantMessagesForFields = array("CASTE"=>"Caste","PHONE_MOB"=>"Phone Number","EMAIL"=>"Email","CITY_RES"=>"City","MTONGUE"=>"Mother Tongue","INCOME"=>"Income","EDU_LEVEL_NEW"=>"Highest Education","OCCUPATION"=>"Occupation","MANGLIK"=>"Manglik","MSTATUS"=>"Marrital Status","DTOFBIRTH"=>"Date of Birth");
