...
class ResponseHandlerConfig
{
  ...
  public static $SEARCH_SAVED_ALREADY_EXISTS = array("message"=>"A search with the same name already exists","statusCode"=>'1');
	...
	public static $FLOGIN_PHONE_ERR=array("message"=>"There are multiple profiles against this phone number, please enter Email Address of account or contact customer care.","statusCode"=>"0");
