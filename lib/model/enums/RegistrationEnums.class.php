...
class RegistrationEnums {
  ...
  public static $pageFieldMap = array(
    ...
    "JSPCR2" => array("MTONGUE", "RELIGION", "CASTE", "SUBCASTE", "CASTEMUSLIM", "MANGLIK", "MSTATUS", "HAVECHILD", "HEIGHT", "COUNTRY_RES", "CITY_RES", "PINCODE","HOROSCOPE_MATCH","CASTE_NO_BAR"),
  ...
  public static $fieldsOnPage = array(
    ...
    "JSPCR2" => array("mtongue", "religion", "caste","casteMuslim", "subcaste", "manglik","horoscopeMatch", "mstatus","mstatus_muslim", "haveChildren", "height", "cityReg", "countryReg", "pincode","stateReg","casteNoBar"),
  ...
  public static $pageFields = array(
    ...
    "JSPCR2"=>array("mtongue", "religion", "caste","castemuslim", "subcaste", "manglik", "horoscope_match","mstatus","havechild", "height", "city_res", "country_res", "pincode","_csrf_token","casteNoBar"),
