...
class RegistrationEnums {
  ...
  public static $pageFieldMap = array(
    ...
    "JSPCR2" => array("MTONGUE", "RELIGION", "CASTE", "SUBCASTE", "CASTEMUSLIM","JAMAAT", "MANGLIK", "MSTATUS", "HAVECHILD", "HEIGHT", "COUNTRY_RES", "CITY_RES", "PINCODE","HOROSCOPE_MATCH","CASTE_NO_BAR","RES_STATUS"),
    "JSPCR3" => array("YOURINFO", "INCOME", "OCCUPATION", "EDU_LEVEL_NEW","COLLEGE","PG_COLLEGE","DEGREE_PG","DEGREE_UG"),
  ...
  public static $fieldsOnPage = array(
    ...
    "JSPCR2" => array("mtongue", "religion", "caste","casteMuslim", "jamaat", "subcaste", "manglik","horoscopeMatch", "mstatus","mstatus_muslim", "haveChildren", "height", "cityReg", "countryReg", "pincode","stateReg","casteNoBar","residentialStatus"),
  ...
  public static $pageFields = array(
    ...
    "JSPCR2"=>array("mtongue", "religion", "caste","castemuslim", "jamaat", "subcaste", "manglik", "horoscope_match","mstatus","havechild", "height", "city_res", "country_res", "pincode","_csrf_token","casteNoBar","res_status"),
    "JSPCR3"=>array("edu_level_new","occupation","income","yourinfo","college","degree_pg","degree_ug","pg_college","_csrf_token"),
