...
class NotificationEnums
{
	...
	public static $scheduledNotificationKey = array('JUST_JOIN','PENDING_EOI','VISITOR','ATN','ETN','VD','MATCHALERT','PROFILE_VISITOR','MEM_EXPIRE','FILTERED_EOI','CONTACTS_VIEWED_BY','CONTACT_VIEWS','PHOTO_UPLOAD','MEM_DISCOUNT','MATCH_OF_DAY','UPGRADE_APP');
      ...
      public static $staticContentNotification = array("FILTERED_EOI", "INCOMPLETE_SCREENING","MATCHALERT","UPGRADE_APP");  //notifications with static content
