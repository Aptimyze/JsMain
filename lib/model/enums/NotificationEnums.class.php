...
class NotificationEnums
{
	...
	public static $scheduledNotificationKey = array('JUST_JOIN','PENDING_EOI','VISITOR','ATN','ETN','VD','MATCHALERT','PROFILE_VISITOR','MEM_EXPIRE_A5','MEM_EXPIRE_A10','MEM_EXPIRE_A15','MEM_EXPIRE_B1','MEM_EXPIRE_B5','FILTERED_EOI','CONTACTS_VIEWED_BY','CONTACT_VIEWS','PHOTO_UPLOAD','MEM_DISCOUNT','LOGIN_REGISTER');
      public static $keyBasedScheduleDaysConfig = array('PENDING_EOI'=>array('SUN','THU'));
      ...
      public static $staticContentNotification = array("FILTERED_EOI", "INCOMPLETE_SCREENING","LOGIN_REGISTER");  //notifications with static content
