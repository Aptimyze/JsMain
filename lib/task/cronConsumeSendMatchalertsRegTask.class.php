...
class cronConsumeSendMatchalertsRegTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeSendMatchalertsReg';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeSendMatchalertsReg] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new sendMatchAlertsRegConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
