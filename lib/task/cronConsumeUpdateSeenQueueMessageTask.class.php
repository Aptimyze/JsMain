...
class cronConsumeUpdateSeenQueueMessageTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeUpdateSeenQueueMessage';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeUpdateSeenQueueMessage] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new updateSeenConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
