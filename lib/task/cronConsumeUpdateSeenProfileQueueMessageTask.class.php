...
class cronConsumeUpdateSeenProfileQueueMessageTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeUpdateSeenProfileQueueMessage';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeUpdateSeenProfileQueueMessage] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new updateSeenProfileConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
