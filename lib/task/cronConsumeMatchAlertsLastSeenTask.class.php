...
class cronConsumeMatchAlertsLastSeenTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeMatchAlertsLastSeen';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeMatchAlertsLastSeen] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new updateMatchAlertsLastSeenConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
