...
class cronConsumeCommunityDiscountQueueMessageTask extends sfBaseTask
{
  /**
   * 
   * Configuration details for cron:cronConsumeCommunityDiscountQueueMessage
   * 
   * @access protected
   * @param none
   */
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeCommunityDiscountQueueMessageTask';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeCommunityDiscountQueueMessageTask] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new CommunityDiscountConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
