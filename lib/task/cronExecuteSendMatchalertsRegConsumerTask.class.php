...
class cronExecuteSendMatchalertsRegConsumerTask extends sfBaseTask
{
  /**
   * 
  ...
  */
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronExecuteSendMatchalertsRegConsumer';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronExecuteSendMatchalertsRegConsumer] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $instancesNum=MessageQueues::UPDATE_MATCHALERT_REG_COUNT;
    for($i=1;$i<=$instancesNum;$i++)
    {
      passthru(JsConstants::$php5path." ".MessageQueues::UPDATEMATCHALERTSREG_STARTCOMMAND." > /dev/null &");
    }
	}
}
?>
