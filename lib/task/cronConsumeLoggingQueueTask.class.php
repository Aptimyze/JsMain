...
class cronConsumeLoggingQueueTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeLoggingQueue';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeLoggingQueue] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new LoggingConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
