...
class cronConsumeQueueMessageTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeQueueMessage';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeQueueMessage] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new Consumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
