...
class cronExecuteScreeningConsumerTask extends sfBaseTask
{
  /**
   * 
  ...
  */
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronExecuteScreeningConsumer';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronExecuteScreeningConsumer] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $instancesNum=MessageQueues::SCREENINGCONSUMERCOUNT;
    for($i=1;$i<=$instancesNum;$i++)
    {
      passthru(JsConstants::$php5path." ".MessageQueues::CRONSCREENINGQUEUE_CONSUMER_STARTCOMMAND." > /dev/null &");
    }
  }
