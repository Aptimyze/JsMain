...
class cronConsumeUpdateFeaturedProfileQueueTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeUpdateFeaturedProfileQueue';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeUpdateFeaturedProfileQueue] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new updateFeaturedProfileConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
