...
class cronExecuteUpdateCriticalInfoConsumerTask extends sfBaseTask
{
  /**
   * 
  ...
  */
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronExecuteUpdateCriticalInfoConsumerTask';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronExecuteUpdateCriticalInfoConsumerTask] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $instancesNum=MessageQueues::UPDATE_CRITICAL_INFO_CONSUMER_COUNT;
    for($i=1;$i<=$instancesNum;$i++)
    {
      passthru(JsConstants::$php5path." ".MessageQueues::UPDATECRITICALINFO_STARTCOMMAND." > /dev/null &");
    }
	}
}
?>
