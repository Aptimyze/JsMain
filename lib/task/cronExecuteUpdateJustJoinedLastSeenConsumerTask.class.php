...
class cronExecuteUpdateJustJoinedLastSeenConsumerTask extends sfBaseTask
{
  /**
   * 
  ...
  */
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronExecuteUpdateJustJoinedLastSeenConsumerTask';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronExecuteUpdateJustJoinedLastSeenConsumerTask] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $instancesNum=MessageQueues::JUST_JOINED_LAST_SEEN_CONSUMER_COUNT;
    for($i=1;$i<=$instancesNum;$i++)
    {
      passthru(JsConstants::$php5path." ".MessageQueues::CRONJUSTJOINEDLASTSEEN_STARTCOMMAND." > /dev/null &");
    }
	}
}
?>
