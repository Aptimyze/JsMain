...
class cronConsumeJustJoinedLastSeenTask extends sfBaseTask
{
  /**
   * 
  ...
  {
    $this->namespace           = 'cron';
    $this->name                = 'cronConsumeJustJoinedLastSeen';
    ...
    $this->detailedDescription = <<<EOF
     ...
     [php symfony cron:cronConsumeJustJoinedLastSeen] 
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $consumerObj=new updateJustJoinedLastSeenConsumer('FIRST_SERVER',0);  //If $serverid='FIRST_SERVER', then 2nd param in Consumer constructor is not taken into account.
