...
class Smarty_Internal_Resource_File {
    ...
    */
    ...
    /**
    * Optimizes template by removing extra whitespaces
    * 
    * @param template content
    * @return Optimized template content after trimming extra whitespaces
    * @author Tanu Gupta
    */
    function trimExtraWhiteSpaces($content)
    {
    ...
    */
    ...
    { 
        ...
        if (file_exists($_template->getTemplateFilepath())) {
            $template_content = file_get_contents($_template->getTemplateFilepath());
	    $_template->template_source = $this->trimExtraWhiteSpaces($template_content);// Added by Tanu
            return true;
        } else {
            return false;
        } 
