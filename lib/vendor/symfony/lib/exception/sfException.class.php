...
class sfException extends Exception
{
  ...
  public function printStackTrace()
  {
    ...
    if (!sfConfig::get('sf_test'))
    {
      ...
      //Modified by Tanu on 09 Jan 13, Bug #67155
      ob_start((sfConfig::get('sf_compressed') && strstr($_SERVER['PHP_SELF'],'symfony_index.php'))? 'ob_gzhandler' : '');
  ...
  static protected function outputStackTrace(Exception $exception)
  {
    ...
    {
      /**********Added by Tanu to customize Jeevansathi 500 Internal Server Error page*******/
