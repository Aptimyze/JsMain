...
class sfValidatorString extends sfValidatorBase
{
  ...
  protected function doClean($value)
  {
	...
	$name=$this->getOption('nameField');
	if($name)
	{
		if(!preg_match(sfValidatorString::REGEX_NAME,$clean))
	  {
		   throw new sfValidatorError($this,"Please provide a valid name" );
	  }
	}
