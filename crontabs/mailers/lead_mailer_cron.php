...
/************************************************************************************************************************
  ...
  * DESCRIPTION        : Mail will be send to the User who are in the REG_LEAD Table for conversion of lead & CRON which will fetch users from last
90 days.
  * Mantis ID          : 4514
...
if($SITE_URL=="http://ser6.jeevansathi.com")
...
$today=date("Y-m-d");
$before_ninty_days=date("Y-m-d", JSstrToTime("-90 days"));

$sql="SELECT LEADID,EMAIL FROM MIS.REG_LEAD WHERE LEAD_CONVERSION='N' AND UNSUB_LEADMAIL!='Y' AND ENTRY_DT BETWEEN '$before_ninty_days' AND '$today' AND TYPE=''";
