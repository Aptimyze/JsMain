...
$sql = "SELECT RECEIPTID,BILLID,PROFILEID,APPLE_COMMISSION,if(TYPE='DOL',AMOUNT*DOL_CONV_RATE,AMOUNT) AS AMOUNT FROM billing.PAYMENT_DETAIL WHERE ENTRY_DT>='$entryDate' and APPLE_COMMISSION>0 AND APPLE_COMMISSION IS NOT NULL";
