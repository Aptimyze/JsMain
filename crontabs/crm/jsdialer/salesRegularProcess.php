...
/* Config array Start */
$campaignArr 		=array('JS_NCRNEW','MAH_JSNEW','OB_NCRNEW','JS_RENEWAL','OB_JS_PAID','OB_RENEWAL_MAH');
$campaignTableArr       =array('JS_NCRNEW'=>array('SALES_CSV_DATA_NOIDA','SALES_CSV_DATA_DELHI'),'OB_NCRNEW'=>array('SALES_CSV_DATA_NOIDA_NEW'),'MAH_JSNEW'=>array('SALES_CSV_DATA_MUMBAI','SALES_CSV_DATA_PUNE'),'JS_RENEWAL'=>array('SALES_CSV_DATA_RENEWAL'),'OB_JS_PAID'=>array('SALES_CSV_DATA_PAID_CAMPAIGN'),'OB_RENEWAL_MAH'=>array('SALES_CSV_DATA_RENEWAL'));
