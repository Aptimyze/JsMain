...
$sq1 = "DELETE FROM js_crm.MESSAGE_LOG_SHARD1 WHERE DATE >= '$lim_31_dt 00:00:00' AND DATE <= '$lim_31_dt 23:59:59'";
mysql_query($sq1,$myDb) or die($sq1.mysql_error($myDb));
$sq2 = "DELETE FROM js_crm.MESSAGE_LOG_SHARD2 WHERE DATE >= '$lim_31_dt 00:00:00' AND DATE <= '$lim_31_dt 23:59:59'";
mysql_query($sq2,$myDb) or die($sq2.mysql_error($myDb));
$sq3 = "DELETE FROM js_crm.MESSAGE_LOG_SHARD3 WHERE DATE >= '$lim_31_dt 00:00:00' AND DATE <= '$lim_31_dt 23:59:59'";
...
$sq1 = "DELETE FROM js_crm.EOI_VIEWED_LOG_SHARD1 WHERE DATE >= '$lim_61_dt 00:00:00' AND DATE <= '$lim_61_dt 23:59:59'";
mysql_query($sq1,$myDb) or die($sq1.mysql_error($myDb));
$sq2 = "DELETE FROM js_crm.EOI_VIEWED_LOG_SHARD2 WHERE DATE >= '$lim_61_dt 00:00:00' AND DATE <= '$lim_61_dt 23:59:59'";
mysql_query($sq2,$myDb) or die($sq2.mysql_error($myDb));
$sq3 = "DELETE FROM js_crm.EOI_VIEWED_LOG_SHARD3 WHERE DATE >= '$lim_61_dt 00:00:00' AND DATE <= '$lim_61_dt 23:59:59'";
mysql_query($sq3,$myDb) or die($sq3.mysql_error($myDb));
...
{
$sq1="INSERT INTO js_crm.MESSAGE_LOG_SHARD1 (SENDER,RECEIVER,TYPE,DATE) VALUES ('$rowml2[SENDER]','$rowml2[RECEIVER]','$rowml2[TYPE]','$rowml2[DATE]')";
mysql_query($sq1,$myDb) or die($sq1.mysql_error($myDb));
}
$resl = mysql_query($sqlle, $shDb1) or die($sqlle . mysql_error($shDb1));
while ($rowml2 = mysql_fetch_array($resl))
{
$sq1="INSERT IGNORE INTO js_crm.EOI_VIEWED_LOG_SHARD1 VALUES ('$rowml2[VIEWER]','$rowml2[VIEWED]','$rowml2[DATE]')";
mysql_query($sq1,$myDb) or die($sq1.mysql_error($myDb));
}
...
while ($rowml2 = mysql_fetch_array($resl)) 
{
$sq2="INSERT INTO js_crm.MESSAGE_LOG_SHARD2 (SENDER,RECEIVER,TYPE,DATE) VALUES ('$rowml2[SENDER]','$rowml2[RECEIVER]','$rowml2[TYPE]','$rowml2[DATE]')";
mysql_query($sq2,$myDb) or die($sq2.mysql_error($myDb));
}
$resl = mysql_query($sqlle, $shDb2) or die($sqlle . mysql_error($shDb2));
while ($rowml2 = mysql_fetch_array($resl))
{
$sq2="INSERT IGNORE INTO js_crm.EOI_VIEWED_LOG_SHARD2 VALUES ('$rowml2[VIEWER]','$rowml2[VIEWED]','$rowml2[DATE]')";
mysql_query($sq2,$myDb) or die($sq2.mysql_error($myDb));
}
...
while ($rowml2 = mysql_fetch_array($resl))
{
$sq3="INSERT INTO js_crm.MESSAGE_LOG_SHARD3 (SENDER,RECEIVER,TYPE,DATE) VALUES ('$rowml2[SENDER]','$rowml2[RECEIVER]','$rowml2[TYPE]','$rowml2[DATE]')";
mysql_query($sq3,$myDb) or die($sq3.mysql_error($myDb));
}
$resl = mysql_query($sqlle, $shDb3) or die($sqlle . mysql_error($shDb3));
while ($rowml2 = mysql_fetch_array($resl))
{
$sq3="INSERT IGNORE INTO js_crm.EOI_VIEWED_LOG_SHARD3 VALUES ('$rowml2[VIEWER]','$rowml2[VIEWED]','$rowml2[DATE]')";
mysql_query($sq3,$myDb) or die($sq3.mysql_error($myDb));
}
