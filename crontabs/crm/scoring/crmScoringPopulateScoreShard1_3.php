...
mysql_query('set session wait_timeout=1000000,interactive_timeout=100000,net_read_timeout=100000',$shDb1);
...
for($t=0;$t<count($modelType_arr);$t++)
{
	...
	$sql = "SELECT DISTINCT(PROFILEID) FROM test.ANALYTIC_SCORE_POOL WHERE MODEL='$modelType' AND SCORE IS NULL AND PROFILEID%6=3";
