...
$sub="Scoring Algorithm Score Computation Shard-2_4";
...
for($t=0;$t<count($modelType_arr);$t++)
{
	...
	$sql = "SELECT DISTINCT(PROFILEID) FROM test.ANALYTIC_SCORE_POOL WHERE MODEL='$modelType' AND SCORE IS NULL AND PROFILEID%6=4";
