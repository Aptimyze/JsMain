...
{ 
		...
		*/
        ...
        if(!empty($nativePlace)){
                $key["NATIVE_STATE"] = $nativePlace["NATIVE_STATE"];
                $key["NATIVE_CITY"] = $nativePlace["NATIVE_CITY"];
