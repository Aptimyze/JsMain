...
{ 
        ...
        if($row[0]){
                ...
                $lastLoginTime = mysql_query($sqlLoginDateTime, $mySlaveDb[$myDbName]) or die("3 6".mysql_error1($db));
      ...
      $sql_update="UPDATE SWAP SET NATIVE_STATE = (SELECT NATIVE_STATE FROM newjs.NATIVE_PLACE WHERE PROFILEID=$profileid) WHERE PROFILEID=$profileid";
...
$sql="delete from SWAP where (ACTIVATED <>'Y' or PRIVACY='C' or SORT_DT < DATE_SUB(CURDATE(), INTERVAL 5 MONTH))";
