<?php
	...
	/************************************************************************************************************************************
	Description :Testing PHP code for memcache
	...
	************************************************************************************************************************************/
	...
	$eventObj = new ProfileMemcacheService($loggedInProfile);
	$eventObj->update("DEC_BY_ME", 1);
	$eventObj->update("PHOTO_REQUEST", 1);
	$eventObj->update("HOROSCOPE", 1);
	$eventObj->update("MESSAGE_NEW", 1);
	$eventObj->updateMemcache();
	$eventObj->get("TODAY_INI_BY_ME");
