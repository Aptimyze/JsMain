...
class ProfileSections {
	...
	public function getRelgionAndEthnicity($casteLabel, $sectLabel) {
		...
		if ($religion == Religion::HINDU) {
			...
			$arr["Sub Caste /Surname"] = $this->profile->getDecoratedSubcaste();
			$arr["Native Place"] = $this->profile->getDecoratedAncestralOrigin();
			$arr["Gothra (Paternal)"] = $this->profile->getDecoratedGothra();
