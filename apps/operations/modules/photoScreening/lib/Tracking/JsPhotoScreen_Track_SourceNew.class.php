<?php
/**
 * JsPhotoScreen_Track_SourceNew Class
 * Tracks source new for PhotoScreen Module
 * @package Operations
 * @subpackage PhotoScreen
 * @author Kunal Verma
 * @created 21th Sept 2014
 */
/**
 ...
 * 
 */
class JsPhotoScreen_Track_SourceNew extends JsPhotoScreen_Tracking
{
	/**
	 ...
	 * @var Enum 
	 */
	public 	$m_enCurrentSource = JsPhotoScreen_Enum::szTRACK_SOURCE_NEW;
	...
	public function trackThis()
	{
		...
		*/
		 ...
		 * 2) First Photo Entry
		 * 3) Update Photo Request Entry in Shards
		 */
