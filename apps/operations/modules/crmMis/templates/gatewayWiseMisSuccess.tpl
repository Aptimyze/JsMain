...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
        ...
        <form name="form1" action="~sfConfig::get('app_site_url')`/operations.php/crmMis/gatewayWiseMis" method="post">
	...
	~else`
		...
		<tr align="center">
			...
			<td class="fieldsnew">
				<input type="radio" name="currency_unit" value="RS" checked><font size=2>&nbsp;Rupees </font></input><br />
				<input type="radio" name="currency_unit" value="DOL"><font size=2>&nbsp;Dollars </font></input><br>
				<input type="radio" name="currency_unit" value="ALL"><font size=2>&nbsp;Total (Converted in Rs.) </font></input><br />
				&nbsp;
			</td>
		</tr>
		<tr></tr>
