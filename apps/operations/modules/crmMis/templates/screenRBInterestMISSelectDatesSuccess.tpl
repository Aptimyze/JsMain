...
<form name="form1" action="~sfConfig::get('app_site_url')`/operations.php/crmMis/screenRBInterestMISSelectDates" method="post">
    ...
    <table border="0" align="center" width="50%" cellpadding="4" cellspacing="4" border="0">
        <tr class="formhead" align="center">
            <td colspan="2" style="background-color:lightblue"><font size=4>Screen RB Interests MIS</font></td>
        </tr>
        <tr class="formhead" align="center">
    ...
    <table border="0" align="center" width="50%" cellpadding="4" cellspacing="4" border="0">
        <tr align="center">
            ...
            <td class="fieldsnew" align="left"><font size=2>
                    <input type="radio" name="dateRange" value="M" id="M" checked>
                    <label for="M">Month wise</label>
            </td>
            <td class="fieldsnew" align="left"><font size=2>
        ...
        <tr align="left">
            <td class="fieldsnew"><font size="2">
                    <input type="radio" name="dateRange" value="C" id="C" checked><font size=2>
                    <label for="C">Current Month</label>
            </td>
        </tr>
        <tr align="center">
