...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<form name="form1" action="~sfConfig::get('app_site_url')`/operations.php/crmMis/cpppMis" method="post">
		<input type="hidden" name="cid" value="~$cid`">

		<br>
		<table border="0" align="center" width="50%" cellpadding="4" cellspacing="4" border="0">
			<tr class="formhead" align="center">
				<td colspan="2" style="background-color:lightblue"><font size=4>CPPP MIS</font></td>
			</tr>
			<tr class="formhead" align="center">
		...
		<table border="0" align="center" width="50%" cellpadding="4" cellspacing="4" border="0">
			...
			<tr align="left">
				...
				<td class="fieldsnew">
					<input type="radio" name="report_format" value="HTML" checked><font size=2>HTML </font></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="report_format" value="XLS"><font size=2>Excel </font></input>
				</td>
			</tr>
			<tr align="center">
