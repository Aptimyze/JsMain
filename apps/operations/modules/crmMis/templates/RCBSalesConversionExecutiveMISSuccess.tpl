...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        ...
        <form name="form1" action="~sfConfig::get('app_site_url')`/operations.php/crmMis/RCBSalesConversionExecutiveMIS" method="post">
    ...
    <tr class="formhead" align="center">
        <td colspan="2" style="background-color:lightblue"><font size=3>RCB Sales Conversion Executive MIS</font></td>
    </tr>
    <tr></tr>
    </table>
    ~if $errorMsg`
