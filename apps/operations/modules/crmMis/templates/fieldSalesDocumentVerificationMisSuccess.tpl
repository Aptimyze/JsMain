...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
        ...
        <form name="form1" action="~sfConfig::get('app_site_url')`/operations.php/crmMis/fieldSalesDocumentVerificationMis" method="post">
	...
	<tr class="formhead" align="center">
		<td colspan="2" style="background-color:lightblue"><font size=3>Field Sales Document Verification MIS</font></td>
	</tr>
	<tr></tr>
	</table>
	...
	~else`
		...
		<tr align="center" style="background-color:SeaShell"><td colspan="2"><font size=2>
			Please use this MIS on or after 5th of the next month for accurate data of any given selected month.
		</td></tr>
