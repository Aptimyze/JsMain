 ...
 <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  <table width=760 cellspacing="1" cellpadding='0' ALIGN="CENTER" >
   <tr width=100% border=1>
	...
	<form name="form1" action="ReleaseProfile?cid=~$cid`" method="post">
	~if $msg eq ''`
		...
		<table width=760 cellspacing="1" cellpadding='0' ALIGN="CENTER" >
	        <tr>
				...
				<p align="center">~$msg`</p>
	                        <a href="~sfConfig::get('app_site_url')`/operations.php/crmDeallocation/ReleaseProfile?cid=~$cid`">Continue </a> 
	                </td>
	        <tr>
		</table>
	~/if`
