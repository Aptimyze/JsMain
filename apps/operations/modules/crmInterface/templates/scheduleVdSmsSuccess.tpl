...
<form action="~sfConfig::get('app_site_url')`/operations.php/crmInterface/scheduleVdSms?cid=~$cid`" method="POST">
	...
	<table width=760 align=center >
		...
		<tr class="formhead" align=center><td colspan=5>SCHEDULE VARIABLE DISCOUNT SMS</tr>
