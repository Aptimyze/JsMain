...
<div id="mainExContent">
	...
	<table align="CENTER" width="150%" table-layout="auto">
		...
		<tr align="CENTER" bgcolor="#fbfbfb" id="exRow~$valued.PROFILEID`">
		    ...
		    ~else`
		    	<td height="21" align="CENTER" id="ASSIGN~$valued.PROFILEID`" width=20%>
		    ...
		    ~/if`
		    <td height="21" align="CENTER"><div class="jsc-ExAllocate jsc-cursp" data="~$valued.PROFILEID`,~$valued.USERNAME`,~$valued.PHONE_MOB`,~$tabChosenDetails.ACTION`"><b>~$tabChosenDetails.ACTION`</td></b></td>
		</tr>
		~/foreach`
		<tr bgcolor="#fbfbfb">
