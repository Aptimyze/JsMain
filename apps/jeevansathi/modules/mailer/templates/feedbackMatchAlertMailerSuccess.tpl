...
~if $feedbackValue eq Y`
	<span id="feedbackYes" style="font-size:18px;padding: 20px;display: block;">Thank you for your feedback, redirecting to Match Alerts...</span>
~else`
...
If you wish to get Match Alerts strictly as per your desired partner profile, you can choose the option from the 'Match Alerts' page of the desktop website.</span>
