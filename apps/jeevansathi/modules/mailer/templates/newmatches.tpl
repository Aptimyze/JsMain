...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="border:1px solid #dcdcdc; max-width:650px; text-align:left" align="center">
        ...
        <tr>
                                ...
                                <tr>
                                    <td valign="top" width="606">
                                        <table border="0" cellspacing="0" cellpadding="0" style="max-width:540px;font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;" align="left">
                                            <tr>
                                                <td width="540">You may be interested to contact the following ~if $data.COUNT eq 1`member~else`people~/if`<b> who joined this week.</b></td>
                                            </tr>
                                        </table>
                                        <table width="60" align="left" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
                                            <tr>
						~if $data.COUNT gt 1 && $data.viewAllLinkFlag eq 'Y'`
                                                	<td><a href="~$mailerLinks['NEW_MATCHES']`~$data.commonParamaters`?From_Mail=Y&stype=~$data.stypeMatch`&relax=~$relaxCriteria`&sent_date=~$data.OpenTracking.sentDate`&logic_used=~$data.logic`" target="_blank" style="color:#14428e; text-decoration:none;">View All</a></td>
						~/if`
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" align="left" style="font-family:Arial; font-size:12px; color:#000000;" width="100%">
                                <tr>
                                    <td height="39" valign="bottom">
                                        Looking for more relevant matches? <a href="~$mailerLinks['MY_DPP']`~$data.commonParamaters`?From_Mail=Y&EditWhatNew=FocusDpp&stype=~$data.stypeMatch`&logic_used=~$data.logic`" target="_blank" style="text-decoration:none; color:#0f529d; display:inline-block;">See/Edit your desired partner profile</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
			...
			<td></td>
                        <td colspan="3">
                            ~include_partial("global/mailerfooter",[logic=>$data.logic,mailerParameter=>"",mailerLinks=>$mailerLinks])`
                        </td>
			<td></td>
                    </tr>
                </table>
