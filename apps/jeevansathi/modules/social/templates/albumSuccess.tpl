<div class="pink" style="width:590px;height:640px;">
<!--margin-left:-130px;">-->
	<div class="topbg">
		<div class="lf pd b t12" style="width: 230px;">~if $noOfPics eq 1` Full View ~else`Album View~/if` - ~$USERNAME`
		</div>
		<div class="lf pd t12">
	...
	~else if $profileDoesntExist eq 1`
	     <div style="margin-top: 190px;font-size:25px;text-align:center;">
	...
	<!--IMAGE CONTAINER-->
	<div class="scrollbox1" style="width:500px;height:529px;float:left;border:0px;overflow:none !important;">
		<div style="padding:5px; text-align:center;width:350px;height:300px;" id="show_img">
			<table height="370px" width="470px">
				<tr>
					<td valign='center'>
					<div style="position: absolute; left: 50px; top: 5px;  height: 100%;z-index: 2000;height: 450px; width: 502px; background:url(/images/trans_overl.png) repeat;" class="gallerylayer" id="overlapLoader"></div>
						<img id="change_img" src="" style="border: 2px solid rgb(0, 0, 0);  max-width: 480px; max-height: 500px;" onload="javascript:set_image()" >
