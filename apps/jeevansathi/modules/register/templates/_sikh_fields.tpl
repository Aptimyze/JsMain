...
<li id="amrit_li">
	~$form['amritdhari']->renderLabel()`
	~$form['amritdhari']->render(['onclick'=>"hide_amrit();"])`
</li>
<li id="padding_amrit" class='amrit' style="display:none">
	~$form['cut_hair']->renderLabel()`
	~$form['cut_hair']->render(['class'=>'sikh_radio'])`
</li>
~if $GENDER eq 'M'`
<li id="padding_beard" class='amrit' style="display:none">
	~$form['trim_beard']->renderLabel()`
	~$form['trim_beard']->render(['class'=>'sikh_radio'])`
</li>
<li id="padding_turban" class='amrit' style="display:none">
	~$form['wear_turban']->renderLabel()`
	~$form['wear_turban']->render(['class'=>'sikh_radio'])`
</li>
<li id="padding_shaven" class='amrit' style="display:none">
	~$form['clean_shaven']->renderLabel()`
	~$form['clean_shaven']->render(['class'=>'sikh_radio'])`
 </li>
~/if`
<!-- Sikh Ends Here -->
