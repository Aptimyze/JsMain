<div class="sp8"></div>
<div class="inner_div" style="height:250px;">
...
~else`
<div class="fs16">To see Phone/Email of this member, </div>
<div class="sp5"></div>~Messages::getBuyPaidMembershipButton(["NAVIGATOR"=>$NAVIGATOR])`
<div class="sp5"></div>
<div class="sp15"></div>
