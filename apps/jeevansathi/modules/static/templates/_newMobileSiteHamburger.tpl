          ...
          <!--end:top header hamburger-->
                ...
                <div class="brdr9_ham pt20">
                  <ul class="fontlig">
                    ...
                    <li><a href="/profile/contacts_made_received.php?page=visitors&filter=R&matchedOrAll=A" bind-slide=1 class="white">Profile Visitors ~if $profileMemcacheObj->get('VISITOR_ALERT')`<span class="dispibl padl10 opa70 f12">~$profileMemcacheObj->get('VISITOR_ALERT')`</span> ~/if`</a></li>
