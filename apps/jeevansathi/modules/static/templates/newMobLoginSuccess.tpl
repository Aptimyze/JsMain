			...
			<div class="lgin_pad1">
				<div class="fl HamiconLogin"> 
					<div id ="hamburgerIcon" hamburgermenu="1" dmove="left" dshow="" dhide="decide" dselect="" dependant="" dcallback="" dindexpos="1">
						...
						<svg id="hamIc" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs><style amp-custom>.cls-1{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.2px;}</style></defs><title>icons</title><line class="cls-1" x1="2" y1="3.04" x2="18" y2="3.04"/><line class="cls-1" x1="2.29" y1="10" x2="18.29" y2="10"/><line class="cls-1" x1="2" y1="16.96" x2="18" y2="16.96"/></svg>
					</div> 
				</div>
	...
	~/if`
			...
			<div class="fullwid brdr9 brdr10 lgin_inp_pad">
				<div class="fl padr10 wid8p">
					...
					<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs><style amp-custom>.cls-1{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.2px;}</style></defs><title>icons</title><path class="cls-1" d="M18,17.14c-.63-2.36-3.69-2.46-4.35-2.75a3.1,3.1,0,0,1-1.28-1,2.45,2.45,0,0,1-.45-1A6.23,6.23,0,0,0,13.8,9.46,2.45,2.45,0,0,0,14.41,8a.82.82,0,0,0-.29-.66,4.38,4.38,0,0,0-4-4.52H10A4.35,4.35,0,0,0,6,7.29.82.82,0,0,0,5.58,8a2.7,2.7,0,0,0,.82,1.67,6.23,6.23,0,0,0,1.69,2.59,2.69,2.69,0,0,1-1.73,2c-.66.29-3.72.48-4.35,2.84Z"/></svg>
				</div>
				...
				<div id="emailErr1" class="fl wid10p txtr" style="display: none">
					...
					<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs><style amp-custom>.cls-1{fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.2px;}.cls-1,.cls-2{stroke:#fff;}.cls-2{fill:#808184;stroke-miterlimit:10;}</style></defs><title>icons</title><circle class="cls-1" cx="10" cy="10" r="8"/><line class="cls-1" x1="10" y1="5.48" x2="10" y2="11.94"/><circle class="cls-2" cx="10" cy="13.72" r="0.49"/></svg>
				 </div>
				<div class="clr"></div>
			</div>
			<!--end:username-->
			...
			<div class="fullwid brdr10 lgin_inp_pad">
				<div class="fl padr10 wid8p pt3">
					...
					<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs><style amp-custom>.cls-1{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.2px;}</style></defs><title>icons</title><path class="cls-1" d="M17.49,2h-2a.5.5,0,0,0-.33.12l-6.9,6A7.31,7.31,0,0,0,7,8,5,5,0,1,0,7,18a4.69,4.69,0,0,0,4.8-4.64,4,4,0,0,0-.52-2.06L13.87,10V7.68h1.81c.26,0,.25,0,.26-.26V5.1h1.81c.32,0,.26.13.26-.26V2.5A.5.5,0,0,0,17.49,2ZM15.16,4,9.32,9.07m-1.64,4.8a1.55,1.55,0,1,0-1.55,1.55A1.55,1.55,0,0,0,7.68,13.87Z"/></svg>
				</div>
				<div class="fl classone wid80p">
