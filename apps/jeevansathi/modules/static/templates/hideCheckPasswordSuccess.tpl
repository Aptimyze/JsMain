<div id="mainContent">
  <div class="loader" id="pageloader"></div>
    <div id="overlayHead" class="bg1 txtc pad15">
        ...
        <a href="/static/hideOption"><i class="mainsp posabs set_arow1 set_pos1"></i></a>
      </div>
    </div>
    ...
    <div id="foot" class="posfix fullwid bg7 btmo">
			<input type="submit" id="hidePasswordCheck" class="fullwid dispbl lh50 txtc f16 white" value="Hide Profile">
		</div>
</div>
