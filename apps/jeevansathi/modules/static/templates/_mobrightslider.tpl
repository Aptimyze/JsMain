...
<div id="slider_right" class="list-menu-right hideslider">
	...
	~if $profileMemcacheObj->get("MATCHALERT")`
		<a href="~sfConfig::get('app_site_url')`/profile/contacts_made_received.php?&page=matches&filter=R" alt="Match Alerts" title="">Match Alerts<strong class="icon-fm">~$profileMemcacheObj->get("MATCHALERT")`</strong></a>
	~/if`
