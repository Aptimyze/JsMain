    ...
    $featuredProfile=1;
		...
		{       
			$loggedInProfileObj = LoggedInProfile::getInstance('newjs_master');			
        	        if($loggedInProfileObj && $loggedInProfileObj->getPROFILEID()=='')
			{
				if(($request->getParameter("justJoinedMatches")==1 || $request->getParameter("twowaymatch")==1 || $request->getParameter("reverseDpp")==1 || $request->getParameter("partnermatches")==1 || $request->getParameter("contactViewAttempts")==1 || $request->getParameter("lastSearchResults")==1 || $request->getParameter("matchofday")==1 || $request->getParameter("matchofdaylist")==1 || in_array($request->getParameter("searchBasedParam"),array('shortlisted','visitors','justJoinedMatches','twowaymatch','reverseDpp','partnermatches','matchalerts','kundlialerts','contactViewAttempts','lastSearchResults','matchofday','matchofdaylist')) || $request->getParameter("dashboard")==1))
				{
		...
		{
                        $searchTypeArray = Array('twowaymatch','reverseDpp','justJoinedMatches','partnermatches','matchalerts','kundlialerts','contactViewAttempts','verifiedMatches','lastSearchResults','matchofday','matchofdaylist');
			...
			else
			{
				...
				else
				{
					...
					*/
					...
					if($request->getParameter("justJoinedMatches")==1 || $request->getParameter("partnermatches")==1 || $request->getParameter("reverseDpp")==1 || $request->getParameter("twowaymatch")==1 || $request->getParameter("verifiedMatches") == 1 || $request->getParameter("contactViewAttempts") == 1 || $request->getParameter("searchBasedParam") == "matchalerts" || $request->getParameter("matchofday")==1 || $request->getParameter("matchofdaylist")==1)
					{
						$noRelaxation = 1;
						$noCasteMapping = 1;
						if($request->getParameter("justJoinedMatches")==1){
				...
				if($request->getParameter("justJoinedMatches")==1 || $request->getParameter("matchalerts")==1 || $request->getParameter("verifiedMatches")==1 || $request->getParameter("kundlialerts")==1 || $request->getParameter("contactViewAttempts")==1 || $request->getParameter("matchofday")==1 || $request->getParameter("matchofdaylist")==1 || in_array($request->getParameter("searchBasedParam"),array('justJoinedMatches','matchalerts','kundlialerts','contactViewAttempts','verifiedMatches','matchofday','matchofdaylist')))
				;
				else
