  ...
  <div class="srpprofbox mt25 js-tupleOuterDiv pos-rel" id="{tupleOuterDiv}">
    ...
    <div class="srppad13 fl srpwid9 ~if !$loggedIn` loginLayerJspc  loginProfileSearch~/if`">
        ...
        <div id="idR{profileNoId}" class="clearfix pt7  cursp" data="{profilechecksum}">
                    ...
                    <div id="idRemove{profileNoId}" class="f11 fontlig colr2 {removeThisProfile} txtr cursp opa40 fr ~if !$loggedIn` loginLayerJspc~else`js-removeProfile~/if`" data="{profilechecksum}">Block This Profile</div>
                    <div id="idRemove{profileNoId}" class="f11 fontlig colr2 js-removeProfile txtr cursp opa40 fr" data="{profilechecksum}">{joinedOnMsg}</div>
            </div>
    </div>
  </div>
