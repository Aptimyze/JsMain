...
class ApiProfileSectionsApp extends ApiProfileSections {
    ...
    $this->addSunSign($astro,$AstroKundali);
		...
		$astro[]=$this->getApiFormatArray("MANGLIK","Manglik" , $this->profile->getDecoratedManglik(),$this->profile->getMANGLIK(),$this->getApiScreeningField("MANGLIK"));
...
//parsi sikh christians
	...
	public function getApiDppReligionAndEth() {
		...
		$arrOut[] = $this->getApiFormatArray("P_MANGLIK","Manglik",trim($jpartnerObj->getDecoratedPARTNER_MANGLIK()),$szManglik,$this->getApiScreeningField("PARTNER_MANGLIK"));
		return $arrOut;		
	}
