	  ...
	  public static $fieldFilterArray = array(
	  	"BASIC" => array(
	  		"AGE" => array(
	  			...
	  			"FILTER_HINT_TEXT" => "Only profiles in the mentioned Age range will be able to contact you",),
	  		"HEIGHT" => FALSE,
	  		"MARITAL_STATUS" => array(
                                "FILTER_MAP" => 'MSTATUS',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles having the specified Marital Status(es) will be able to contact you",),
	  			"HAVE_CHILDREN" => FALSE,
	  		"COUNTRY" => array(
                                "FILTER_MAP" => 'COUNTRY_RES',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles living in the specified Countries will be able to contact you",),
	  		"CITY" => array(
                                "FILTER_MAP" => 'CITY_RES',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles living in the specified Cities will be able to contact you",),),
	  	"RELIGION_ETHINICITY" => array(
	  		"RELIGION" => array(
                                "FILTER_MAP" => 'RELIGION',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles with the specified Religion(s) will be able to contact you",),
	  		"CASTE" => array(
                                "FILTER_MAP" => 'CASTE',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles with the specified Caste(s) will be able to contact you ",),
	  		"MOTHER_TONGUE" => array(
                                "FILTER_MAP" => 'MTONGUE',
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles with the specified Mother Tongue(s) will be able to contact you",),
	  		"MANGLIK" => FALSE,),
	  	"EDUCATION" => array(
	  		...
	  		"INCOME" =>array(
	  			...
	  			"FILTER" => self::VALUE_YES,
	  			"FILTER_VALUE" => self::VALUE_NO,
	  			"FILTER_HINT_TEXT" => "Only profiles in the mentioned Income range will be able to contact you",),),
	  	"LIFESTYLE" => array(
	  		"DIETRY_HABITS" => FALSE,
