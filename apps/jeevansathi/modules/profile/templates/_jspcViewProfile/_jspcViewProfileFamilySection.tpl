                ...
                <div class="pl31 prflist1 js-familyView">
                  ...
                  ~/if`
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="mother_occView" ~if $bEditView && $apiData["family"]["mother_occ"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="father_occView" ~if $bEditView && $apiData["family"]["father_occ"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="sibling_sisterView" ~if $bEditView && $apiData["family"]["sibling"]["sibling_sister"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="sibling_brotherView" ~if $bEditView && $apiData["family"]["sibling"]["sibling_brother"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20" >
                        <span id="sub_casteView" ~if $bEditView && $apiData["family"]["sub_caste"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20" >
                        <span id="gothraView" ~if $bEditView && $apiData["family"]["gothra"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20" >
                        <span id="gothra_maternalView" ~if $bEditView && $apiData["family"]["gothra_maternal"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="profile_posted_byView" ~if $bEditView && $apiData["family"]["profile_posted_by"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="family_statusView" ~if $bEditView && $apiData["family"]["family_status"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="family_incomeView" ~if $bEditView && $apiData["family"]["family_income"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="family_typeView" ~if $bEditView && $apiData["family"]["family_type"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="family_valuesView" ~if $bEditView && $apiData["family"]["family_values"] eq $notFilledInText`  class="color5" ~/if` >
                    ...
                    <li>
                      ...
                      <p class="pt2 pr20">
                        <span id="native_placeView" ~if $bEditView && $apiData["family"]["native_place"] eq $notFilledInText`  class="color5" ~/if` >
