<div id="forgotPasswordLayer" class="pos_fix layersZ disp-none">
<i id="closeForgotLogin" class="sprite2 close pos_fix closepos cursp"></i>
<!--start:layer-->
<div id="forgotPasswordContainer" class="pos_fix fontlig setshare">
<div class="mauto layerbg wid520">
<div class="layerp1">
<div class="f17 grey5" id="titleErr">Forgot Password</div>
<div class="mt10">
<div id="ForgotPasswordMessage" class="f15 colr2 pt10"></div>
