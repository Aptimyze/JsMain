  ...
  <div  class="SMSContactsDiv posabs colr5 disp-none cursp" style='right:16px;top:3px;'>SMS these details to me</div> ~/if`
		<ul id="cEViewContactListing" class="ceviewcontct fontlig">
			<li class="clearfix">
				...
				<div class="fl">{{CONTACT_VALUE}}<span id = "buttonForReportInvalid" class="{{DISP_REPORT}} cursp disp_ib pl30 color11 reportInvalid" {{phonetype}}>Report Invalid</span></div>
                ...
                <div class="pl12 pt20">
                  <p id='RAReasonHead' class="color12 f13">Select reason</p>
                    <ul class="listnone reportlist fontlig f15 pt10 color2">
                      <li>
                          <input type="radio"  name="report_profile">Phone is not reachable</li>
                          <li>
                          <input type="radio"   name="report_profile">Not an account holder's phone</li>
                           <li>
                          <input type="radio"   name="report_profile">Fake number</li>
                            <li>
                          <input type="radio"  name="report_profile">Invalid phone number</li>
