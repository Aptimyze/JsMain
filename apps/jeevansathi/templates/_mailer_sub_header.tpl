...
<tr>
	<td width="500" style="padding-left:10px;" height="52">
               <div style="width:100%"><a href="~JsConstants::$siteUrl`" target="_blank" style="color:#f7f6f6;  width: inherit; text-decoration:none;"><img src="~sfConfig::get('app_img_url')`/images/jspc/commonimg/logo1.png" alt="Jeevansathi.com" align="left" border="0" vspace="0" hspace="0" style="max-width:204px;"></a></div>
        </td>
