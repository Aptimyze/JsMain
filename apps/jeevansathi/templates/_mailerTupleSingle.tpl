<table align="left" border="0" cellspacing="0" cellpadding="0" width="100%" style="font-family:Arial, Verdana; font-size:12px; color:#000000;-webkit-text-size-adjust: none; text-align:left;">
    <tr>
        <td></td>
        <td height="28" style="padding-left:5px;"><a href="~$mailerLinks['DETAILED_PROFILE_HOME']`~$commonParameters`?profilechecksum=~$user->getPROFILECHECKSUM()`&logic_used=~$logic`&stype=~$stypeMatch`~if $fromMatchAlert` &fromMatchAlert=~$fromMatchAlert`~/if`" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#14428e; text-decoration:none;">~$user->getUSERNAME()`</a></td>
    ...
    <tr>
        ...
        <td style="width:100px;" height="140" valign="top">
             <a href="~$mailerLinks['DETAILED_PROFILE_HOME']`~$commonParameters`?profilechecksum=~$user->getPROFILECHECKSUM()`&logic_used=~$logic`&stype=~$stypeMatch`~if $fromMatchAlert` &fromMatchAlert=~$fromMatchAlert`~/if`" style="text-decoration:none; color:#0f529d;" target="_blank">
    ...
    <tr>
        ...
        <td colspan="2" style="padding-right: 5px;">
            About ~$user->getUSERNAME()`: ~$user->getYOURINFO()`... <a href="~$mailerLinks['DETAILED_PROFILE_HOME']`~$commonParameters`?profilechecksum=~$user->getPROFILECHECKSUM()`&logic_used=~$logic`&stype=~$stypeMatch`~if $fromMatchAlert` &fromMatchAlert=~$fromMatchAlert`~/if`" target="_blank" style="font-size:12px; color:#14428e; font-family:Arial, Helvetica, sans-serif; text-decoration:none;">Read more</a> 
	</td>
    </tr>
    ~/if`
    <tr>
