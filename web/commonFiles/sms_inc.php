...
function insertValues($guidArr,$receiver,$messageType)
{
        ...
        foreach($guidArr as $id => $guid)
        {
                ...
                $res1 = mysql_query($sql1,$dbM) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($dbM)));
                }
        }
}
	...
	mysql_ping($dbM);
		...
		if($k=='')
			$invalid='B';
                ...
                $res2 = mysql_query($sql2,$dbM) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($dbM)));
        }
        ...
        foreach($reasonCodeArr as $k=>$v)
        {
                ...
                mysql_query($sql2,$dbM) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($dbM)));
        }
