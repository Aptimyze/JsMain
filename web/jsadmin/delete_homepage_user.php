...
if(authenticated($data))
{
	if($Continue)
	{
		...
		$sql="DELETE HP.* FROM newjs.HOMEPAGE_PROFILES AS HP,newjs.JPROFILE AS JP WHERE HP.PROFILEID=JP.PROFILEID AND JP.LAST_LOGIN_DT<=DATE_SUB(CURDATE(),INTERVAL 45 DAY)";
