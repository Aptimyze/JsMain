...
{
        $sql = "INSERT IGNORE INTO MAILER (GENDER, AGE, CASTE_ID, EMAIL) values ('$gender', '$age','$caste', '$email')";
...
else
{
        ...
        $sql_caste = "select SQL_CACHE VALUE, LABEL from newjs.CASTE ";
        ...
        $smarty->display("newsppr_inputrec.tpl");
?>
