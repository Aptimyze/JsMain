...
VALUES (
'',  'EXCLUSIVE_PROPOSAL_SMS',  'I',  '',  'P',  'A',  'SINGLE',  '0',  '0',  'SERVICE',  'Y',  'Hi, JS Exclusive client {USERNAME_ID} likes your profile.We will call you shortly to know your response. View the profile here {DESCRIPTION_LINK}.'
);
