...
'', '1837', 'exclusiveServiceIIMailer.tpl', NULL , NULL , NULL , '29', '1', '~$SENDER_EMAIL`', 'Jeevansathi Exclusive Service II', 'D', NULL , NULL , NULL , '~$SENDER_NAME`', 'NULL', NULL , NULL , NULL , NULL , '');
