...
ALTER TABLE billing.`LIGHTNING_DEAL_DISCOUNT` ADD DEAL_DATE date DEFAULT NULL;

ALTER TABLE billing.`LIGHTNING_DEAL_DISCOUNT` DROP INDEX `PROFILEID`, ADD UNIQUE `PROFILEID`(`PROFILEID`,`DEAL_DATE`);