...
ALTER TABLE `JPROFILE` ADD `PROFILE_HANDLER_NAME` varchar(40),
		...
		ADD `CALL_ANONYMOUS` CHAR(1),
		CHANGE `PHOTOSCREEN` `PHOTOSCREEN` TINYINT UNSIGNED DEFAULT '1';
...
OTHER_PG_DEGREE varchar(250) NOT NULL, ADD UG_DEGREE TINYINT(3) NOT NULL,ADD SUNSIGN TINYINT(3), MODIFY `SCREENING` BIGINT( 15 ) UNSIGNED DEFAULT '0';
