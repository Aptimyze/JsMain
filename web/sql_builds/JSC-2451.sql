...
CREATE TABLE billing.`COMMUNITY_WELCOME_DISCOUNT_LOG` (  `PROFILEID` int(11) DEFAULT NULL,  `DISCOUNT` tinyint(4) DEFAULT NULL,  `COMMUNITY` int(3) DEFAULT NULL,  `ENTRY_DT` date DEFAULT NULL,  UNIQUE KEY `PROFILEID_DATE` (`PROFILEID`,`ENTRY_DT`),  KEY `PROFILEID` (`PROFILEID`),  KEY `ENTRY_DT` (`ENTRY_DT`)) ENGINE=InnoDB;
