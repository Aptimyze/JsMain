...
<title>Jeevansaathi - Error</title>
...
<span class="help">IF YOU ARE FACING ANY PROBLEM IN FILLING IN YOUR CV DETAILS, PLEASE SEND YOUR FEEDBACK TO </span>

<p>&nbsp;</p>
<div align="center" class="text" style="color:#ff0000;"><img src="images/reserror.gif" width="50" height="51" align="absmiddle">~$msg_error`</div>
~if $from_createnew eq "1"`
<div align="center"> 
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <a href="javascript:window.close();">Close This Window</a>

              </div>
			  ~else`
<div align="center" class="text" style="color:#ff0000;"><td><input type="button" name="submit2" value="Go Back" class="buttons1" onClick="Javascript:history.go(-1)"></td></div>
~/if`
<p>&nbsp;</p>
