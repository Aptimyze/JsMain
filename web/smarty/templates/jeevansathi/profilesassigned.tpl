...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" width="26%" bgcolor="#EFEFEF"><img src="images/nauklogo.gif" width="209" height="63" usemap="#Map" border="0"></td>
    <td valign="top" width="29%" bgcolor="#EFEFEF">&nbsp;</td>
  ...
  <tr bgcolor="#C4BFC4" >
    <td valign="top" colspan="3"><img src="images/spacer.gif" width="1" height="2"></td>
  </tr>
</table>
...
<table width=100% cellspacing="1" cellpadding='0' ALIGN="CENTER" >
     <tr width=100% border=1>
	  ...
	  <td width="97%" class="formhead" height="23"><font><b>Welcome :~$name`</b></font></td>	  
     </tr>
</table>  
  <table width=100% align="CENTER" >
   <tr>
    <td height="23" class="formhead">
    
    You have successfully assigned ~$count` records <br><br>
    
    ~if ($new)`<a href="/anmol/shownewrecords.php?name=~$name`">~else`<a href="/anmol/showeditedrecords.php?name=~$name`"> ~/if`continue</a>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#C4BFC4"><img src="images/spacer.gif" width="1" height="2"></td>
  </tr>
  <tr>
