...
~include file="head.htm"`
  ...
  <input type=hidden name="from_dialer" value="~$from_dialer`">
  <input type=hidden name="from_dialer_phone" value="~$from_dialer_phone`">
  <input type=hidden name="from_dialer_inbound" value="~$from_dialer_inbound`">
