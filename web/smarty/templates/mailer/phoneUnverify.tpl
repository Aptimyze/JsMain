        ...
        <tr>
          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              ...
              <tr>
                      ...
                      <td valign="top"><br /><font color="#000000">We have temporarily unverified your number ~$phone_num` since members on the site reported this number as invalid and despite our best efforts we could not reach you.</font></td>
              </tr>
              <tr>
                
                      <td valign="top"><br /><font color="#000000">Kindly login and verify your number to use the site as before</font></td>
              </tr>             
              <tr>
