~assign var="count" value=$eoi_profile_filter_inputs|@count`
~foreach from=$eoi_profile_filter_inputs item=eoiProfileId key=eoi_draft`
                    ...
                    <tr>
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td width="280">
                                        <table width="110" border="0" cellspacing="0" cellpadding="0" align="left">
                                            <tr>
                                                <td width="133"><a href="(LINK)DETAILED_PROFILE_HOME:profileid=~$profileid`,receiver_id=~$eoiProfileId`,source=~JSTrackingPageType::EOI_FILTER_MAILER`(/LINK)" style="text-decoration:none; color:#0f529d;" target="_blank"><img border="0" align="left" width="110" vspace="0" hspace="0" height="110" src="(PHOTO)PROFILE_PIC:receiver_id=1,profileid=~$eoiProfileId`,photo_type=contactMailer(/PHOTO)" style="border:1px solid #e6e6e6;"></a></td>
                                            </tr>
                                            <tr>
                                                <td height="15"></td>
                                            </tr>
                                        ...
                                        <table width="150" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Verdana; font-size:12px; color:#000000;-webkit-text-size-adjust: none; text-align:left;">
                                            ...
                                            <tr>
                                                <td width="5"></td>
                                                <td><var>{{INCOME:profileid=~$eoiProfileId`}}</var> per annum</td>
                                            </tr>
                                            <tr>
                                                <td width="5"></td>
                            ...
                            <table style="width:260px; " border="0" cellspacing="0" cellpadding="0" align="left">
                                ...
                                <tr>
                                    <td width="20"></td>
                                    <td width="220" style="font-family:Arial, Verdana; font-size:12px; color:#4a4a4a;-webkit-text-size-adjust: none; text-align:left; word-break: break-word;"> <span><var>{{YOURINFO:profileid=~$eoiProfileId`}}</var></span> <a href="(LINK)DETAILED_PROFILE_HOME:profileid=~$profileid`,receiver_id=~$eoiProfileId`,source=~JSTrackingPageType::EOI_FILTER_MAILER`(/LINK)" target="_blank" style="font-size:12px; color:#14428e; font-family:Arial, Helvetica, sans-serif;word-break: keep-all;text-decoration: none;"> Read more</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" align="left" width="100" style="font-family:Arial, Verdana; font-size:14px;">
                                            <tr>
                                                <td bgcolor="#ad160d" align="center" width="100" height="27">
                                                    <a style="text-decoration:none; width:100px; color:#ffffff; float:left" target="_blank" href="(LINK)ACCEPT:profileid=~$profileid`,receiver_id=~$eoiProfileId`,source=eoiFilter(/LINK)"> <strong>Accept</strong> </a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="10"></td>
                                    <td><a style="font-size:12px; color:#14428e; font-family:Arial, Helvetica, sans-serif; text-decoration:underline;" target="_blank" href="(LINK)DECLINE:profileid=~$profileid`,receiver_id=~$eoiProfileId`,source=eoiFilter(/LINK)">Not interested</a> </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
