                    ...
                    <tr>
                        <td valign="top" height="20" colspan="2">
                            <table style="max-width:600px; min-width:240px" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="20"></td>
                                    <td style="font-size:12px; font-family: Arial, Helvetica, sans-serif;"><span color="#0f529d"><a href="(LINK)EOI_RECEIVIED:profileid=~$profileid`(/LINK)" style="color:#14428e; text-decoration:underline;">~$totalCount` people</a></span> have sent you an interest, and would like to receive your response.</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
