        ...
        <tr>
          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              ...
              <tr>  
                      ...
                      You had purchased an eRishta membership on ~$memPurchasedDate`. Here is a chance to upgrade to next level membership (eValue) by paying just Rs.~$upgradePrice`.
                      </font></td>
              </tr>
              
              <tr>
                      <td><br /><font color="#000000">
                      With an eValue membership, even free members will be able to contact you directly and hence it will increase the number of calls you receive from prospects by 3 times.
                      </font></td>
              </tr>
              <tr>
                      <td><br /><font color="#000000">
                              <a href="~$membershipPageLink`">Upgrade to eValue</a> @ Rs.~$upgradePrice` only
                      </font></td>
              </tr>
