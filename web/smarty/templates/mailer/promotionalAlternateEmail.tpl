            ...
            <td>
                <table style="border-spacing:0px 10px; max-width:600px; min-width:240px; font-family:Arial, Helvetica, sans-serif; font-size:12px" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="20"></td>
                        <td>
                            We understand that the marriage decision is one which is made as a family and hence we give you the opportunity to stay updated as a family. Now you can add one more Email ID of a family member who will receive important info and updates ( Interest received , acceptances , etc ) and some of our top recommendations ( Just joined , Daily recommendations ).
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            This family member will also be able to login to your profile through that Email and use the site on your behalf. Please ensure it’s someone close to you.
                        </td>
                    </tr>
                    <tr>
                        <td width="20"></td>
                        <td>
                            The additional Email will need to be verified by the email owner by clicking on our Email verification Mail.
                        </td>
                    </tr>
                    <tr>
                        <td width="20"></td>
                        <td>
                            Go ahead and use this option and let us know how you find it
                        </td>
