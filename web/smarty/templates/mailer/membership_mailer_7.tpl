...
<table style="max-width:600px; min-width:240px; border:1px solid #dcdcdc;"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td width="20"></td>
    <td>
Your Basic account allows you to send and receive expressions of interest, but would you not like to contact people you like at your convenience?<br /><br />  You can upgrade your membership (starting as low as <strong>just ~$membershipMsg` per day!</strong>) and directly contact people you like on their phone/email.</td>
    <td width="20"></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <tr>
    	...
    	<td height="30" style="border-bottom:1px solid #eae9e9"></td>
