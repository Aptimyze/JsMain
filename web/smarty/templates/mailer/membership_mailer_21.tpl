...
<table style="max-width:600px; min-width:240px; border:1px solid #dcdcdc;"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
  <td valign="top">
  <table style="max-width:570px; min-width:240px; font-family:Arial, Helvetica, sans-serif; font-size:12px" border="0" cellspacing="0" cellpadding="0">
   <tr>
    <td height="15"></td>
    <td></td>
    <td ></td>
  ...
  <tr>
    ...
    Hi <var>{{USERNAME:profileid=~$profileid`}}</var>
</td>
  ...
  <tr>
    <td width="20"></td>
    <td>
Are you still waiting for someone to call or email you on Jeevansathi? Take the first step and contact people you like before they are contacted by others.<br /><br />

Hundreds of people easily find and contact their partners everyday on Jeevansathi.com. Find yours too - Upgrade your membership (starting as low as just ~$membershipMsg` per day!)
</td>
    <td width="20"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td></td>
    <td>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #e3e2e2;">
  <tr>
  ...
  <tr>
    ...
    <td valign="middle" align="center" style="border-right:1px solid #e3e2e2; border-bottom:1px solid #e3e2e2;" bgcolor="#ebeaea" width="112">starting at<br />
<strong>~$currency` ~$eRishta`</strong></td>
    <td align="center" valign="middle" width="112" style="border-right:1px solid #e3e2e2; border-bottom:1px solid #e3e2e2;" bgcolor="#ebeaea">starting at<br />
<strong>~$currency` ~$eValue`</strong></td>
    <td width="112" style="border-bottom:1px solid #e3e2e2;" align="center" valign="middle" bgcolor="#ebeaea">starting at<br />
<strong>~$currency` ~$eValuePlus`</strong></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <a href="(LINK)MEMBERSHIP_DETAIL:profileid=~$profileid`(/LINK)" style="color:#0f529d" target="_blank">Read more about the plans</a>
</td>
    <td></td>
  </tr>
</table>
  ...
  <tr>
      ...
      <td colspan="2" width="570"><table style="max-width:570px; min-width:240px" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
      ...
      <td height="15" align="right" style="border-bottom:1px solid #eae9e9"></td>
...
<table cellspacing="0" cellpadding="0" border="0" align="left" width="" style=" margin:0px">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#003a7e" align="center" height="27" style="border:1px solid #003a7e;"><a style="font-family:Arial; font-size:13px; color:#ffffff; text-decoration:none; line-height:25px; width:100%; float:left" target="_blank" href="(LINK)MEMBERSHIP_DETAIL:profileid=~$profileid`(/LINK)"><strong>Upgrade Membership</strong></a></td>
                    </tr>
                    <tr>
                      <td></td>
  ...
  <tr>
        ...
        <table style="max-width:570px; min-width:240px"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20"></td>
  ...
  <tr>
    	...
    	<td valign="top"><table style="max-width:570px; min-width:240px" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20"></td>
