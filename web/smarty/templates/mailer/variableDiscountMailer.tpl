    ...
    <td width="575"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
        ...
        <tr>
          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              <tr> 
                  <td>Please add ~$fromEmailId` to your address book to ensure delivery of this mail into you inbox.</td>
              </tr>
                      
              <tr>
                <td valign="top"><br><br>Dear  <var>{{NAME_PROFILE:profileid=~$profileid`}}</var>, </td>
              </tr>
	      <br\>	
              <tr>
              	<td style="color:#000000;">
		<strong>Congratulations!</strong></font> You have been selected for a special discount of ~$vdDisplayText` ~$discount`% on buying paid membership on Jeevansathi<span style="font-size:1px;"> </span>.com.<br />
		<br \>
As a paid member, you can directly call or email members you like, and get closer to meeting your Jeevansathi.
		</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><a href="(LINK)MEMBERSHIP:profileid=~$profileid`(/LINK)" target="_blank"><b>Upgrade</b></a> at ~$vdDisplayText` ~$discount`% OFF or Call 1800 419 6299.
                </td>
              </tr>
              <tr>
                <td valign="top"><br />
                        <font color="#000000">
                                Hurry! This offer expires on <strong>~$day`<sup>~$suffix`</sup> ~$month` ~$year`</strong>.
              ...
              <tr>
                  <td><br><br>
                      You have received this mail because your e-mail ID is registered with Jeevansathi.com. This is a system-generated e-mail, please don't reply to this message. To stop receiving these mails <a href='~$unsubscribeLink`/0/0' target="_blank" style="text-decoration:none;">Unsubscribe</a>.
                  </td>
              </tr>
              <tr>
