        ...
        <td width="575"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
            ...
            <tr>
                ...
                <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
                    <tr>
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-bottom:10px; font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;">Dear ~$userName`,</td><br>
                                </tr>
                    ...
                    <tr>
                        <td valign="top" style="font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;"><br />
                                A while back, you had deleted your profile stating that you found your match on Jeevansathi.
                            </td>
                    </tr>
                    <tr>
                        <td style="font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;"><br />
                    ...
                    <tr>
                        <td style="padding-bottom: 10px; font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;"><br />
            ...
            <tr>
                ...
                <td><table style="font-family:Arial" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;" valign="top" height="25">A sweet surprise will be waiting for you after you submit your success story.</td>
                    </tr>
                    <tr>
                        <td><table style="padding-top: 10px; font-family:Arial,Times New Roman,Times,serif;font-size:12px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;" width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr><td style="font-size:12px;" valign="top">Team Jeevansathi</td></tr>
                                </tr>
                            </tbody>
                        </table></td>
                    </tr>
