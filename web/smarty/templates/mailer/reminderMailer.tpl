...
~$PREHEADER`
            ...
            <td>
                <table style="max-width:600px; min-width:240px; font-family:Arial, Helvetica, sans-serif; font-size:12px" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="20" ></td>
                        <td>
                You contacted these profiles some days back and have not yet received a response. Quite possibly, they were not highly active last week or they have shortlisted your profile.
            </td>
        ...
        ~$reminderMailerTuple`
                 ...
                 <tr>
                        <td width="20" ></td>
                        <td>
                <a style="font-family:Arial; font-size:12px; line-height:25px; width:100%; float:left" target="_blank" href="(LINK)INTEREST:profileid=~$profileid`(/LINK)">View All</a>
