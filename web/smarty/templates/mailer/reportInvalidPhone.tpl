    ...
    <td width="575"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
        ...
        <tr>
          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              ...
              <tr>
                    <td valign="top"><br /><font color="#000000">We have temporarily unverified your number ~$phoneNumber` since members on the site reported this number as invalid and despite our best efforts we could not reach you.</font></td>
              </tr>
        ...
        <tr>
          ...
          <td><table style="font-family:Arial" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="font-size:12px;" valign="top" height="25">Kindly login and verify your number to use the site as before</td>
              </tr>
              <tr>
