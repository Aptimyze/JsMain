...
<table width="150" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Verdana; font-size:12px; color:#000000;-webkit-text-size-adjust: none; text-align:left;">
  ...
  <tr>
    <td width="20"></td>
    <td width="560">
    <strong>Your interest could be declined due to the following ~if $lowscore lte 55`reasons~else`reason~/if` :</strong>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15"><img src="~$IMG_URL`/images/mailer/ADRM/point.jpg" /></td>
    <td height="25">Your profile doesn't meet this member's set criteria</td>
  </tr>
  ~if $lowscore lte 55`
  <tr>
    <td height="25"><img src="~$IMG_URL`/images/mailer/ADRM/point.jpg" /></td>
    <td>Your profile needs more information ~if $photo eq 0` and photo ~/if`</td>
  </tr>
  ~elseif $photo eq 0`
  <tr>
    <td height="25"><img src="~$IMG_URL`/images/mailer/ADRM/point.jpg" /></td>
...
~if $lowscore lte 55 or $photo eq 0`
  <tr>
...
~/if`
  ...
  <tr>
    <td height="15"></td>
    <td>
    <strong>To increase chances of acceptances :</strong>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ~if $photo eq 0`
  <tr>
    <td width="15"><img src="~$IMG_URL`/images/mailer/ADRM/point.jpg" /></td>
  ...
  <tr>
    <td height="25"><img src="~$IMG_URL`/images/mailer/ADRM/point.jpg" /></td>
    <td><a href="(LINK)DETAILED_PROFILE_HOME:receiver_id=~$profileid`,profileid=~$profileid`(/LINK)" style="color:#003a7e; text-decoration:underline;">Add More Information</a></td>
  </tr>
  ~/if`
</table>
    </td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25" valign="top">Express Interest in these people who match your desired partner preferences:</td>
  </tr>
  <tr>
   ~$suggested_profiles`
  </tr>
