...
<tbody><tr>
<td style="font-size: 11px !important; font-family: Arial; color: black; padding-top: 10px;">~$PREHEADER`</td>
</tr>
</tbody></table>
<table style="max-width:600px; min-width:240px; border:1px solid #dcdcdc;"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td style="border-bottom:1px solid #ededed"><table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
          <td width="373" height="52" style="padding-left:10px;"><div style="width:100%"><img border="0" align="left" vspace="0" hspace="0" style="max-width:204px;" alt="Jeevansathi.com" src="~$IMG_URL`/images/jspc/commonimg/logo1.png"></div></td>
          <td width="189" valign="middle" style="padding-right:10px;"><table cellspacing="0" cellpadding="0" border="0" align="right" width="189">
              <tr>
                <td align="right" valign="middle" height="50" style="vertical-align:middle;"><a style="font-size:12px; color:#14428e; font-family:Arial, Helvetica, sans-serif;text-decoration: none;" target="_blank" href="(LINK)COMPLETE_PROFILE:profileid=~$profileid`(/LINK)">My Profile</a> | <a style="font-size:12px; color:#14428e; font-family:Arial, Helvetica, sans-serif;text-decoration: none;" target="_blank" href="(LINK)SUGGESTED_MATCHES:profileid=~$profileid`(/LINK)">Desired Partner Matches</a></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
  ...
  <tr>
    <td width="20"></td>
   <td>
<var>{{USERNAME:profileid=~$otherProfile`}}</var> has viewed your profile details and would also like to see your horoscope to take things forward.</td>
    <td width="20"></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td style="font-family:Arial, Helvetica, sans-serif; font-size:12px;"><a href="(LINK)HOROSCOPE_REQUEST_PAGE:profileid=~$profileid`(/LINK)" style="color:#0f529d; text-decoration:underline">A few more</a> member~if $TOTAL_REQUEST neq 1`s~/if` ~if $TOTAL_REQUEST eq 1`has~else`have~/if` requested for your horoscope. <a href="(LINK)HOROSCOPE_REQUEST_PAGE:profileid=~$profileid`(/LINK)"  style="color:#0f529d; text-decoration:underline">View All</a> Horoscope requests. </td>
  </tr>
</table>
  ...
  <tr>
    <td><table cellspacing="0" cellpadding="0" border="0" style="max-width:330px;">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#ad160d" align="center" width="150"  height="27"><a style="text-decoration:none; font-size:12px; font-family:Arial, Helvetica, sans-serif;   color:#ffffff; width:100%; " target="_blank" href="(LINK)UPLOAD_HOROSCOPE:profileid=~$profileid`(/LINK)"> <strong>Add Horoscope Now</strong></a></td>
                  </tr>
                </table>
                        </td>
                        <td width="1"></td>
...
<tr>
    	<td valign="top">
                <table style="font-family:Arial, Helvetica, sans-serif; font-size:12px"border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="20" height="20"></td>
                          <td width="545" colspan="2">Benefits of adding horoscope:<br /><br /></td>
                        </tr>
                        <tr>
                          <td width="20" height="20"></td>
                          <td width="25"><img src="~$IMG_URL`/images/mailer/photoRequest/arrow-point.jpg" /></td>
                          <td width="545">You can see 'Guna Match' with other users</td>
                        </tr>
                        <tr>
                          <td width="20" height="20"></td>
                          <td width="25"><img src="~$IMG_URL`/images/mailer/photoRequest/arrow-point.jpg" /></td>
                          <td width="545">Many people on Jeevansathi are interested in matching horoscopes</td>
                        </tr>
