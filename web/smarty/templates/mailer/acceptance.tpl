...
<var>{{USERNAME:profileid=~$otherProfile`}}</var> has accepted your expression of interest. </td>
  ...
  <tr>
    <td width="133"><a href="(LINK)DETAILED_PROFILE_HOME:profileid=~$profileid`,receiver_id=~$otherProfile`(/LINK)" style="text-decoration:none; color:#0f529d;" target="_blank"><img border="0"  align="left" width="100" vspace="0" hspace="0" height="133" src="(PHOTO)PROFILE_PIC:receiver_id=~$profileid`,profileid=~$otherProfile`,photo_type=mailer(/PHOTO)" style="border:1px solid #e6e6e6;"></a></td>
