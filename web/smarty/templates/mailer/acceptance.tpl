...
~$PREHEADER`
  ...
  <tr>
    <td width="20"></td>
   <td>
<var>{{USERNAME:profileid=~$otherProfile`}}</var> has accepted your expression of interest. </td>
    <td width="20"></td>
  </tr>
</table>
...
<table width="150" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Verdana; font-size:12px; color:#000000;-webkit-text-size-adjust: none; text-align:left;">
  ...
  <tr>
    ...
    <tr>
    <td width="5"></td>
    <td><var>{{OCCUPATION:profileid=~$otherProfile`}}</td>
  </tr>
    <tr>
    <td width="5"></td>
  ...
  <tr>
   ...
   <tr>
      ...
      <td height="10" style="border-top:1px solid #eae9e9"></td>
  ...
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="left" style="font-family:Arial; font-size:12px; color:#000000; max-width:340px;">
                    <tr>
                    <td width="20"></td>
                      <td width="340" height="24" colspan="2"><font color="#000000" face="Arial" style="line-height:20px;"><strong>Take the next step to Contact ~$himher` now:</strong></font></td>
                    </tr>
                    <tr>
                    <td width="20"></td>
...
<table cellspacing="0" cellpadding="0" border="0" align="left" width="" style=" margin:0px">
 ...
 ~/if` 
  ...
  <tr>
    ...
    <td><a href="(LINK)CC_PEOPLE_WHO_ACCEPTED_ME_URL:profileid=~$profileid`(/LINK)" style="color:#0f529d; text-decoration:none;">View All Accepted Members</a></td>
  </tr>
</table>
