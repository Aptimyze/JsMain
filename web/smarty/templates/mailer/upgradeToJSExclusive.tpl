          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              <tr>
                <td>
                  <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                          <td>Hi <var>{{NAME_PROFILE:profileid=~$profileid`}}</var>,</td>
                        </tr>
              ...
              <tr>  
                      <td valign="top"><br /><font color="#000000">
                              You had purchased an eAdvantage membership on ~$memPurchasedDate`. Here is a chance to upgrade to next level membership (JS Exclusive) by paying just Rs.~$upgradePrice`.
                      </font></td>
              </tr>
              <tr>
                      <td><br /><font color="#000000">
                      With a JS Exclusive membership, you get a dedicated relationship manager who will:
                      <li>Continuously interact with you to know every little detail of what you expect from your life partner</li>
                      <li>Utilize our intelligent match making systems and expertise to shortlist potential matches for you</li>
                      <li>Periodically connect with you to share those matches and take your consent to choose the most suitable ones</li>
                      <li>Introduce you to the chosen matches & arrange meetings on your behalf with the family / prospects at your convenience</li>
                      
                      </font></td>
              </tr>
              <tr>
                      <td><br /><font color="#000000">
                              <a href="~$membershipPageLink`">Upgrade to JS Exclusive</a> @ Rs.~$upgradePrice` only
                      </font></td>
              </tr>
