        ...
        <tr>
          ...
          <td width="531"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
              ...
              <tr>  
                      ...
                      You had purchased an eValue membership on ~$memPurchasedDate`. Here is a chance to upgrade to next level membership (eAdvantage) by paying just Rs.~$upgradePrice`.
                      </font></td>
              </tr>
              <tr>
                      <td><br /><font color="#000000">
                            With an eAdvantage membership, you get the following additional benefits:<br/>
                            <li>Feature at top of search results<br/></li>
                            <li>Feature at top of daily recommendations<br/></li>
                            <li>Be shown in the 'Match of the day' section on website and apps<br/></li>
                            <li>Your profile is sent in the 'Match of the day' notification to matching members<br/></li>
                      </font></td>
              </tr>
              
              <tr>
                      <td><br /><font color="#000000">
                              <a href="~$membershipPageLink`">Upgrade to eAdvantage</a> @ Rs.~$upgradePrice` only
                      </font></td>
              </tr>
