            ...
            <tr>
              ...
              <td width="531">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Times New Roman, Times, serif; font-size:12px; color:#000000; text-align:left;">
                  ...
                  <tr>
                    <td style="color:#000000;">We have received your request for visit by Jeevansathi executive. We will reach out to you within 48 working hours for scheduling the same. If you have questions or wish to cancel the request, please call us at 18004196299.
                    </td>
                  </tr>
                </table>
              </td>
                  ...
                  <tr>
                    <td>
                      <table style="font-family:Arial,Times New Roman,Times,serif;font-size:11px;line-height:17px; color:#000000; -webkit-text-size-adjust: none;" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                          <tr>
                            <td style="font-size:12px; padding-bottom:10px;" valign="top">Thank you for your interest!</td>
                          </tr>
                          <tr>
