            ...
            $("#hamburgerIcon").bind("click", function() {
                if($("#hamburger").length == 0){
                  ...
                  //  $("#hamburgerIcon").off("click");
                    $("#perspective").append('    <div id="hamburger" class="white posfix wid90p fullheight"><div id="outerHamDiv"><div id="mainHamDiv" ><div id="newHamlist" class="hamlist hampad1" ><ul id="scrollElem" style="-webkit-overflow-scrolling: touch;margin-left:0px" class="fontreg white listingHam overAutoHidden"><li style="padding: 10px 20px;" class="f13 pb8 fontlig"><div id="appDownloadLink1" class="dispnone"><a bind-slide=1   href="/static/appredirect?type=jsmsHamburger" target="_blank" class="white fl mar0Imp">Download  App | 3MB only </a></div><div class="dispnone" id="appleAppDownloadLink1"><a bind-slide=1   href="/static/appredirect?type=jsmsHamburger&channel=iosLayer" target="_blank" class="white fl mar0Imp">Download iOS App </a></div><div class="fr dispibl"><div id="hindiLink" onclick="translateSite(\'http://js.mox.net.in\');" class="white mar0Imp">हिंदी में</div></div></li><div style="height: 1px;padding: 0px 20px;"><div style="background-color: white;height: 1px;opacity: .5;"></div></div><li class="mb12"><i class="hamSprite homeIcon mt10Imp"></i><a id="homeLink1" class="white" href="/">Home</a></li><li class="mb12"><i class="hamSprite searchIcon"></i><a id="searchLink" class="white" href="/search/topSearchBand?isMobile=Y">Search</a></li><li class="mb12"><i class="hamSprite searchProfileIcon"></i><a id="searchProfileIdLink" href="/search/searchByProfileId" class="white">Search by Profile ID</a></li><li class="mb12"><i class="hamSprite editProfileIcon"></i><a href="/browse-matrimony-profiles-by-community-jeevansathi" id="borwseCommLink" class="white">Browse By Community</a></li><li class="mb12"><div id="settingsParent"><i class="hamSprite settingsIcon"></i><div id="settingsLink" class="ml10 dispibl white">Settings & Assistance</div><i id="expandSettings" class="hamSprite plusIcon fr"></i></div><ul id="settingsMinor" class="minorList f15" style="margin-top: 12px;padding-left:40px;height:0px;"><li class="mb12 "><a id="contactUsLink" href="/contactus/index" class="newS white">Contact Us</a></li><li class="mb12"><a id="privacyPolicyLink" href="/static/page/privacypolicy" class="newS white">Privacy Policy</a></li><li class="mb12"><a id="termsLink" href="/static/page/disclaimer" class="newS white">Terms of use</a></li><li class="mb12"><a id="fraudLink" href="/static/page/fraudalert" class="newS white">Fraud Alert</a></li><li class="mb12"><a id="switchLink" href="/?desktop=Y" class="newS white">Switch to Desktop Site</a></li></ul></li></ul><div id="bottomTab" class="mar0Imp posabs btm0 fullwid"><div class="brdrTop pad150 fontreg"><div class="dispibl wid49p pad16"><a id="homeLink2" class="hamBtnLoggedOut bg10 lh40 br6 white" href="/">LOGIN</a></div><div class="dispibl wid49p pad16"><a class="bg7 br6 lh40 white hamBtnLoggedOut" href="/register/page1?source=mobreg4">REGISTER</a></div></div></div></div></div></div></div><div id="hamView" class="fullwid darkView fullheight hamView dn"></div>');
