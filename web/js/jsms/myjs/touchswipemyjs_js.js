(function ($) {
    $.fn.Slider = function (id, parent, no_of_tuples,mapString,next) {
 ...
 var slider = {"threshold": 80, "working": false, "v_threshold": 20, "movement": true, "transform": 0, "index": 0, "maxindex": 0};
