...
function ShowHamSearch(type,tapid)
{
	...
	if(searchid.length)
		searchid.val("");
	if($.inArray(type,['reg_city_jspc','state_res','city_res','country_res','caste','p_caste','p_country','p_city','occupation','mtongue','reg_mtongue','sect'])==-1 && type.indexOf('reg_caste_') ==-1)
	{   
