...
function bindQuesClick(elem, quesAns2) {
    $("#" + elem + " li").each(function(index, element) {
        $(this).off("click").on("click", function() {
            ...
            $("#sectionQuesDiv, #firstPageDiv,#hamburgerIcon, #backBtnSection").addClass("dispnone"), $("#questionAnswerDiv,#backBtnQues").removeClass("dispnone");
            $("#backBtnQues").off("click").on("click", function() {
                if (elem == "quesList") {
                    $("#sectionQuesDiv,#backBtnSection").removeClass("dispnone"), $("#firstPageDiv, #questionAnswerDiv,#backBtnQues, #hamburgerIcon").addClass("dispnone");
                } else {
                    $("#firstPageDiv,#backBtnSection").removeClass("dispnone"), $("#sectionListing,#hamburgerIcon,#sectionQuesDiv, #questionAnswerDiv,#backBtnQues").addClass("dispnone");
                }
            });
        });
    });
...
function bindBackButton(elem) {
    $("#backBtnSection").off("click").on("click", function() {
        ...
        $("#hamburgerIcon").removeClass("dispnone"), $("#backBtnQues, #backBtnSection").addClass("dispnone");
    });
}
...
function bindSectionClick() {
    ...
    $(".sectionList li").each(function(index, element) {
        $(this).on("click", function() {
            ...
            $("#firstPageDiv, #questionAnswerDiv,#hamburgerIcon, #backBtnQues").addClass("dispnone"), $("#sectionQuesDiv,#backBtnSection").removeClass("dispnone");
