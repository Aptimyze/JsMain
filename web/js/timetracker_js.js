var tnm = function() {
    ...
    this.tnmLogPath= "/logtimetracker.php";
    this.tnmLogArray = {"value":false, "error":true, "links":false};
    this.tnmLogFields={};
    /*= { "myform":[ "email", "sex" ],
          "form2":[ "mno", "Number", "city", "education" ]
      };*/
    this.tnmPageId="Page Id Not Specified/error";
    ...
    this.makeResLog = function() {
        ...
        tnmxhr.open("POST","/logtimetracker.php",false);
