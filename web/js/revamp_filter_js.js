...
{	
	...
	appendSendingData("skipToFto","1",0);
	if(document.getElementById("crmback").value!="")
	{
		appendSendingData("crmback",document.getElementById("crmback").value,0);
		appendSendingData("crmredirect",document.getElementById("crmredirect").value,0);
		appendSendingData("cid",document.getElementById("cid").value,0);
	}
	
	var ce_url=SITE_URL+"/register/page6";
