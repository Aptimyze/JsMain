...
var pathToImages = '/images/99_calender/';	// Relative to your HTML file
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput)
{
	...
	// added to prevent empty calendar in case of junk inputs - ajay
	if((isNaN(inputYear) || isNaN(inputMonth)) || (inputMonth>12 || inputMonth<1))
	{
		var d = new Date();
		currentMonth = d.getMonth();
		currentYear = d.getFullYear();
...
function closeDatePickerOnLayerClose() {
	var el = document.getElementById('srpmodalCloseCrossBtn');	
