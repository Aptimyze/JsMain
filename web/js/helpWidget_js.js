...
$(document).ready(function(){
    ...
    if( window.location.href.indexOf("/register/") != -1                    || 
       ...
       (window.location.href.indexOf("profile/registration_page1.php")!=-1 )
      ){
        return;
    }
    ...
    $(requestCallBack).click(function(){toggleRequestCallBackOverlay(1);})
    $(requestCallBackClose).click(function(){toggleRequestCallBackOverlay(0);})
...
function collapseHelpWidget(){
    var width = $(helpWidgetContent)[0].getBoundingClientRect().width * -1;
    $(helpWidget).animate({'right':width+'px'},200);
}
...
function expandHelpWidget(){
    ...
    $(helpWidget).animate({'right':'0px'},200);
}
