...
//user in myjs for calculating width of box1 class based on total number of item in the list
function calWidth(param) {
    $('.' + param).find("ul li").each(function() {
        widMyjsSlide += ($(this)[0].getBoundingClientRect().width);
    });
    $('.' + param).css('width', widMyjsSlide);
}
