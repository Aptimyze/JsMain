                ...
                functions = {
                        ...
                        if (o.advanced.autoExpandHorizontalScroll && o.axis !== "y") {
                            ...
                            */
                            mCSB_container.css({
                                "position": "absolute",
                                "width": "auto"
                            }).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({ /* set actual width, original position and un-wrap */
                                /* 
                    ...
                    _scrollButtons: function() {
                        var $this = $(this),
                            ...
                            btnHTML = ["<a href='#' class='mCSB_buttonUp' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonDown' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonLeft' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonRight' oncontextmenu='return false;' />"],
                    ...
                    _mousewheel: function() {
                        ...
                        if (d) { /* Check if the scrollbar is ready to use mousewheel events (issue: #185) */
                            ...
                            el.bind("mousewheel." + namespace, function(e, delta) {
                                ...
                                functions._scrollTo($this, (contentPos - (dlt * amount)).toString(), {
                                    dir: dir
                                });
                            });
                        }
                    ...
                    */
                    ...
                    _to: function(val, dir) {
                        ...
                        switch (t) {
                            case "function":
                                /* this currently is not used. Consider removing it */ return val();
                                break;
                            case "object":
                                if (val.nodeType) { /* DOM */
