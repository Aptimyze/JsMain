      ...
      if(!getCookieData("appPromo") && (typeof appPromo === 'undefined') && AppLoggedInUser )
      {
		   writeCookie("appPromo","jeevansathi",3);
			...
			if($("#mainContent").length){
				...
				if(getAndroidVersion())
				{
					$("#mainContent").before("    <div id=\"appPromo\" class=\" ham_b20 ham_minu20  newocbbg1 fullwid\">    	<div class=\"padAppPromo clearfix\">        	<div onclick=\"showPromo(4);\" class=\"fl pt20\">            	<div class=\"ocbnewimg ocbclose\"></div>            </div>        	<div class=\"fl padl5\">            	<div class=\"ocbnewimg logoocb\"></div>            </div>            <div class=\"fr pt10\">            	<div class=\"newocbbg2 ocbbr1 ocbp1\">                	<a href=\"/static/appredirect?type=androidLayer\" class=\"white fontmed f13\">Install</a>                </div>            </div>             <div class=\"fr pt13 padr10\">            	<div class=\"f14 fontmed\">Jeevansathi App | 2.9 MB </div>                <div class=\"ocbnewimg ocbstar\" style =\"float:right\"></div>            </div>        </div>    </div>");
