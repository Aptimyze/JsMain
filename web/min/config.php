 ...
 */
$min_builderPassword = 'hullagulla';
...
$min_cachePath = JsConstants::$cronDocRoot.'/cache/Minify';
 ...
 */
$min_serveOptions['maxAge'] = 3600*24*20*365;
 ...
 */
$min_serveOptions['minifiers']['application/x-javascript'] = array('Minify_ClosureCompiler', 'minify');

//uncomment following line if you want to use google cloud API
