...
if($count){
	...
	$sql_a = "SELECT PROFILEID, USERNAME, PHONE_MOB, SUBSCRIPTION, LAST_LOGIN_DT FROM JPROFILE WHERE DATE(LAST_LOGIN_DT)>='$back_90_days' AND ACTIVATED='Y' AND COUNTRY_RES='51' AND SERVICE_MESSAGES!='U' AND GET_SMS!='N' AND PHONE_MOB!='' AND MOB_STATUS='Y' and   activatedKey=1 ";
