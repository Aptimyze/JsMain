...
function DebugStart() {
	if (!this.debugW || this.debugW.closed) { // open the debugger window
		...
		if (!debugW)
			debugW = window.open("jschat/Debugger.html","debugW"+encWN(this.id),"width=480,height=320,scrollbars=yes,resizable=yes");
		else if (!debugW.location.href.match(/Debugger.html$/))
			debugW.location.href = "jschat/Debugger.html";
