...
JSJaCMessage.prototype.setImage=function(image){
	this._setChildNode("image",image);
	return this;
};
JSJaCMessage.prototype.getImage=function(){
	return this.getChildVal('image');
};

JSJaCMessage.prototype.setProperty=function(propertyName,propertyValue){
	this._setChildNode(propertyName,propertyValue);
	return this;
};
JSJaCMessage.prototype.getProperty=function(propertyName){
	return this.getChildVal(propertyName);
};

JSJaCMessage.prototype.setUserName=function(userName){
	this._setChildNode("userName",userName);
	return this;
};
JSJaCMessage.prototype.getUserName=function(){
	return this.getChildVal('userName');
};
JSJaCMessage.prototype.setFirstMes=function(firstmes){
        this._setChildNode("firstmes",firstmes);
        return this;
};
JSJaCMessage.prototype.getFirstMes=function(){
        return this.getChildVal("firstmes");
};
