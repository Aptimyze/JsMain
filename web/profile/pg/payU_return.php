...
if ($hash == $reverseHash && $AuthDesc == "Y") {
    ...
    error_log("ankita in startServiceOrder1 payu_return");
    if (!$dup && $ret) {
        error_log("ankita in startServiceOrder payu_return");
        $membershipObj->startServiceOrder($Order_Id,false,true);
    }
