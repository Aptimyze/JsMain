			...
			if(gadget_name=='partner_mtongue')
			{
				...
				{		
						...
						if(document.getElementById('partner_mtongue_displaying_13')){
							...
							document.getElementById('partner_mtongue_10,19,33,7,28,13,41').checked=true;
						}
						flag_all=1;
				}
				else
...
var partner_fields_array = new Array("partner_mstatus","partner_religion","partner_mtongue","partner_income");
var registration={
	'input' : function(element){
			element.onclick = function(){
				if(this.name.match("submitReg"))
				{
					check_gender();	
					return false;
				}
