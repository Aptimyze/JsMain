...
var box_action_values = new Array("", "", "");
...
{
	var gender_value=get_gender_value();
	if(gender_value=='F')
		var mstatus_radio_buttons = document.getElementById("mstatus_female").value;
	else
		var mstatus_radio_buttons = document.getElementById("mstatus").value;
	return mstatus_radio_buttons;
}
...
/*Function to filter partner income checkbox*/
function partner_income_checkbox(partner_income_value)
{
	var selected_income = docF.income.value;
	var temp_arr = partner_income_value.split(",");
	var max_val = max(temp_arr);
//	alert(selected_income);

	if(selected_income == 5 || selected_income == 6)
	{
		if(max_val > 4)
			return 1;
		else
	...
	else if((selected_income == 16 || selected_income == 17))
	{
		if(max_val > 6)
			return 1;
		else
	...
	else if(selected_income == 18 || selected_income == 8)
	{
		if((max_val >= 8 && max_val <= 14) || max_val > 17)
			return 1;
		else
			return 0;
	}
	else if(selected_income == 20 || selected_income == 9 || selected_income == 10)
	{
		if((max_val >= 8 && max_val <= 14) || in_array(20,temp_arr))
			return 1;
		else
			return 0;
	}
	else if(selected_income == 11 || selected_income == 12)
	{
		if((max_val >= 11 && max_val <= 14) || max_val == 21)
			return 1;
		else
			return 0;
	}
	else if(selected_income == 13)
	{
		if(max_val == 13 || max_val == 14 || max_val == 21)
			return 1;
		else
			return 0;
	}
	else if(selected_income == 21)
	{
		if(max_val == 14 || max_val == 21)
			return 1;
		else
			return 0;
	}
	else if(selected_income == 14)
	{
		if(max_val == 14)
			return 1;
		else
	...
	else if(selected_income == 22)
	{
		if((max_val >= 8 && max_val <= 14) || in_array(22,temp_arr))
			 return 1;
	        else
	                 return 0;
	}
	else if(selected_income == 23)
	{
		if((max_val >= 8 && max_val <= 14) || in_array(23,temp_arr))
			 return 1;
	        else
	                 return 0;
	}
