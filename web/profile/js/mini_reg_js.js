...
function get()
{
	var value = "email_val=" + encodeURI( document.getElementById("email_val").value ) + "&mobile=" + encodeURI( document.getElementById("mobile").value ) + "&source=" + encodeURI( document.getElementById("source").value );
