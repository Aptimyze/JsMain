...
//	document.getElementById('caste_error').style.display="none";
	...
	if( docF.email_val.value=="" || docF.day.value=="" || docF.month.value=="" || docF.year.value=="" || docF.mtongue.value=="" ||  docF.relationship.value=="" || docF.country_Code.value=="" || docF.mobile.value=="")
	{
