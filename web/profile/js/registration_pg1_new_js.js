...
var basicInfo_section_arr = new Array("gender","day","month","year","mstatus","has_children","height","country_residence","city_residence","country_code","state_code","country_code_mob","phone","showphone","mobile","showmobile");
var religionEthnicity_section_arr = new Array("mtongue","religion","speak_urdu","caste");
var educationCareer_section_arr = new Array("degree","occupation","income");
...
function validate(obj,to_validate_field)
{
	...
	for(var i=0;i<i1;i++)
	{
		...
		if(field_name=="email")
		{
			...
			if(!(email_act.indexOf("@")!=-1 && email_act.indexOf(".")!=-1))
			//if(""==docF.email.value)
			{
