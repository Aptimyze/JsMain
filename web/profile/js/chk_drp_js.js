...
function risa1()
{
	...
	document.getElementById("pickup_image2_new").style.display="none";
}
function risa2()
{
        if(document.getElementById("d2"))
...
function risa3()
{
        ...
        document.getElementById("da4").style.color="#000000";
	document.getElementById("pickup_image2").style.display="none";
	document.getElementById("pickup_image2_new").style.display="block";
}
function risa4()
{       
