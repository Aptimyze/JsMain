...
hide_arr= new Array();
show_arr= new Array(3,4,6,9);
var i2=show_arr.length;
hide_arr[6]=new Array('9');
hide_arr[4]=new Array(6,9);
hide_arr[3]=new Array(4,6,9);
hide_arr[2]= new Array(3,4,6,9);
...
function AC(duration,flag,shrink,dur)
{
		...
		if(dur)
                        for(var i in addon)
                        {
                                if(i == dur)
                                {
                                        a_name=addon[i]['T']['name'];
                                        a_price=addon[i]['T']['price'];
                                }
                        }
