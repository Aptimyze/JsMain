...
if (isset($data) || $JSIndicator) {
    ...
    if ($CMDGo && $viewmode == 'O') {
        ...
        $sql_min = "SELECT MIN(BILLID) AS MIN,MAX(BILLID) AS MAX FROM billing.PAYMENT_DETAIL WHERE ENTRY_DT BETWEEN '$yr1-$mnth1-01 00:00:00' AND '$yr2-$mnth2-31 23:59:59'";
        ...
        */
        ...
        if ($branch != "ALL") {
            ...
            if ($vtype == 'Q') {
                ...
                $qflag = 1;
                $qyearp1 = $qyear + 1;
                $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,QUARTER(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as qtr,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$qyear-04-01 00:00:00' AND '$qyearp1-03-31 23:59:59' AND billing.PURCHASES.CENTER='$branch' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                $sql.= " GROUP BY QUARTER(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),eb";
            ...
            elseif ($vtype == 'M') {
                ...
                if ($pay_exec == "Selected") {
                    $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as mm,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$myear-04-01 00:00:00' AND '$myearp1-03-31 23:59:59' AND billing.PURCHASES.CENTER='$branch' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                    if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                    $sql.= " GROUP BY month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),eb";
                    ...
                    if ($pay_exec == 'P') {
                        ...
                        $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as mm,billing.PAYMENT_DETAIL_NEW.MODE as mode FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$year-04-01 00:00:00' AND '$yearp1-03-31 23:59:59' AND billing.PURCHASES.CENTER='$branch' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                        if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                    ...
                    elseif ($pay_exec == 'E') {
                        ...
                        $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as mm,billing.PURCHASES.WALKIN as walkin FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$year-04-01 00:00:00' AND '$yearp1-03-31 23:59:59' AND billing.PURCHASES.CENTER='$branch' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                        if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
            ...
            elseif ($vtype == 'D') {
                ...
                $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,DAYOFMONTH(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as dd,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$dyear-$dmonth-01 00:00:00' AND '$dyear-$dmonth-31 23:59:59' AND billing.PURCHASES.CENTER='$branch' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                $sql.= " GROUP BY DAYOFMONTH(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),eb";
                $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                while ($row = mysql_fetch_array($res)) {
                    $dd = $row['dd'] - 1;
                    if ($branch == "HO") {
            ...
            if ($vtype == 'Q') {
                ...
                $qflag = 1;
                $qyearp1 = $qyear + 1;
                $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,QUARTER(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as qtr,billing.PURCHASES.CENTER as center,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$qyear-04-01 00:00:00' AND '$qyearp1-03-31 23:59:59' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                $sql.= " GROUP BY QUARTER(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),center,eb ORDER BY center,eb";
                $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
               ...
               $center = "Total-excluding-Misc-(without-tax)";
                ...
                if ($offline_str != '') {
                    ...
                    $k = array_search($center, $brancharr);
                    $sql = "SELECT sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE, AMOUNT )) AS amt_net,QUARTER(a.ENTRY_DT) as qtr FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$qyear-04-01 00:00:00' AND '$qyearp1-03-31 23:59:59' AND a.STATUS = 'DONE' and a.BILLID IN ($offline_str) group by qtr";
                    $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                    while ($row = mysql_fetch_array($res)) {
                        $qtr = $row['qtr'] - 1;
                        if ($qtr < 1) {
                ...
                $k = array_search($center, $brancharr);
                $sql = "SELECT sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, QUARTER(a.ENTRY_DT) as qtr FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$qyear-04-01 00:00:00' AND '$qyearp1-03-31 23:59:59' AND a.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') ";
            ...
            elseif ($vtype == 'M') {
                ...
                $mflag = 1;
                $myearp1 = $myear + 1;
                $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as mm,billing.PURCHASES.CENTER as center,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$myear-04-01 00:00:00' AND '$myearp1-03-31 23:59:59' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                if ($offline_str != '') $sql.= "and billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                $sql.= " group by  month(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),center,eb ORDER BY center,eb";
                ...
                if ($offline_str != '') {
                    $center = "OFFLINE-REVENUE-WITHOUT-TAX";
                    $k = array_search($center, $brancharr);
                    $sql = "SELECT sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE, AMOUNT )) AS amt_net, MONTH(a.ENTRY_DT) as qtr FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$myear-04-01 00:00:00' AND '$myearp1-03-31 23:59:59' AND a.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') and b.BILLID IN ($offline_str) group by qtr";
                    $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                    while ($row = mysql_fetch_array($res)) {
                        $qtr = $row['qtr'];
                        if ($qtr <= 3) {
                ...
                $center = "REVENUE-WITHOUT-TAX";
                $k = array_search($center, $brancharr);
                $sql = "SELECT sum(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, MONTH(a.ENTRY_DT) as qtr FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$myear-04-01 00:00:00' AND '$myearp1-03-31 23:59:59' AND a.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK')";
                if ($offline_str != '') $sql.= " and b.BILLID NOT IN ($offline_str) ";
                $sql.= " group by qtr";
                $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                while ($row = mysql_fetch_array($res)) {
            ...
            elseif ($vtype == 'D') {
                ...
                $sql = "SELECT sum(if(billing.PAYMENT_DETAIL_NEW.TYPE='DOL',billing.PAYMENT_DETAIL_NEW.AMOUNT*billing.PAYMENT_DETAIL_NEW.DOL_CONV_RATE,billing.PAYMENT_DETAIL_NEW.AMOUNT)) as amt,DAYOFMONTH(billing.PAYMENT_DETAIL_NEW.ENTRY_DT) as dd,billing.PURCHASES.CENTER as center,billing.PURCHASES.WALKIN as eb FROM billing.PAYMENT_DETAIL_NEW,billing.PURCHASES WHERE billing.PAYMENT_DETAIL_NEW.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') AND billing.PAYMENT_DETAIL_NEW.ENTRY_DT BETWEEN '$dyear-$dmonth-01 00:00:00' AND '$dyear-$dmonth-31 23:59:59' AND billing.PURCHASES.BILLID=billing.PAYMENT_DETAIL_NEW.BILLID ";
                if ($offline_str != '') $sql.= "AND billing.PURCHASES.BILLID NOT IN ($offline_str) ";
                $sql.= " GROUP BY DAYOFMONTH(billing.PAYMENT_DETAIL_NEW.ENTRY_DT),center,eb ORDER BY center,eb";
                ...
                if ($offline_str != '') {
                    ...
                    $sql = "SELECT SUM(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, SUM(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE, AMOUNT)) AS amt_net, DAYOFMONTH(a.ENTRY_DT) as dd FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$dyear-$dmonth-01 00:00:00' AND '$dyear-$dmonth-31 23:59:59' AND a.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') and b.BILLID IN ($offline_str) group by dd";
                    $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                    while ($row = mysql_fetch_array($res)) {
                        $dd = $row['dd'] - 1;
                ...
                $center = "REVENUE-WITHOUT-TAX";
                $k = array_search($center, $brancharr);
                $sql = "SELECT SUM(IF (TYPE = 'DOL', AMOUNT *DOL_CONV_RATE / ( 1+ TAX_RATE /100 ), AMOUNT / ( 1+ TAX_RATE /100 ) )) AS amt, DAYOFMONTH(a.ENTRY_DT) as dd FROM billing.PAYMENT_DETAIL_NEW a, billing.PURCHASES b WHERE a.BILLID = b.BILLID AND a.ENTRY_DT BETWEEN '$dyear-$dmonth-01 00:00:00' AND '$dyear-$dmonth-31 23:59:59' AND a.STATUS IN ('DONE','BOUNCE','CANCEL', 'REFUND', 'CHARGE_BACK') ";
                if ($offline_str != '') $sql.= "and b.BILLID NOT IN ($offline_str) ";
                $sql.= " group by dd";
                $res = mysql_query_decide($sql, $db) or die("$sql" . mysql_error_js($db));
                while ($row = mysql_fetch_array($res)) {
       ...
       if ($JSIndicator == 1) {
        ...
        $sql_min = "SELECT MIN(BILLID) AS MIN,MAX(BILLID) AS MAX FROM billing.PAYMENT_DETAIL_NEW WHERE ENTRY_DT BETWEEN '$yr1-$mnth1-01 00:00:00' AND '$yr2-$mnth2-31 23:59:59'";
        $res_min = mysql_query_decide($sql_min, $db) or die("$sql_min" . mysql_error_js($db));
        $row_min = mysql_fetch_assoc($res_min);
        $min = $row_min['MIN'];
        $max = $row_min['MAX'];
