...
if(authenticated($cid) || $JSIndicator==1)
{
	if($CMDGo)
	{
		...
		$sql="SELECT COUNT(*) as count ,SEARCH_TYPE  FROM MIS.SEARCHQUERY2  WHERE DATE BETWEEN '$st_date' AND '$end_date' GROUP BY SEARCH_TYPE";
...
/**************************************End of Addition********************************************************************/ 	
		...
		if(!$field)
		{
			$sql="SELECT COUNT(*) AS cnt ,PROFILEID FROM MIS.SEARCHQUERY2  WHERE DATE BETWEEN '$st_date' AND '$end_date' GROUP BY PROFILEID";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$sone=0;
			$stwofive=0;
			$sfiveten=0;
			...
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE CASTE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$caste=$row['cnt'];
			if($total!=0)
				$castep=substr(($caste*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE MTONGUE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$mtongue=$row['cnt'];
			if($total!=0)
			...
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE WITHPHOTO!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$withphoto=$row['cnt'];
			if($total!=0)
			...
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE MANGLIK!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$manglik=$row['cnt'];
			if($total!=0)
				$manglikp=substr(($manglik*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE MSTATUS!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$mstatus=$row['cnt'];
			if($total!=0)
				$mstatusp=substr(($mstatus*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE CHILDREN!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$children=$row['cnt'];
			if($total!=0)
				$childrenp=substr(($children*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE BTYPE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$btype=$row['cnt'];
			if($total!=0)
				$btypep=substr(($btype*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE COMPLEXION!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$complexion=$row['cnt'];
			if($total!=0)
				$complexionp=substr(($complexion*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE DIET!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$diet=$row['cnt'];
			if($total!=0)
				$dietp=substr(($diet*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE SMOKE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$smoke=$row['cnt'];
			if($total!=0)
				$smokep=substr(($smoke*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE DRINK!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$drink=$row['cnt'];
			if($total!=0)
				$drinkp=substr(($drink*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE HANDICAPPED!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$handicapped=$row['cnt'];
			if($total!=0)
				$handicappedp=substr(($handicapped*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE OCCUPATION!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$occupation=$row['cnt'];
			if($total!=0)
				$occupationp=substr(($occupation*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE COUNTRY_RES!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$country_res=$row['cnt'];
			if($total!=0)
				$country_resp=substr(($country_res*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE CITY_RES!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$city_res=$row['cnt'];
			if($total!=0)
				$city_resp=substr(($city_res*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE RES_STATUS!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$res_status=$row['cnt'];
			if($total!=0)
				$res_statusp=substr(($res_status*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE EDU_LEVEL!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$edu_level=$row['cnt'];
			if($total!=0)
				$edu_levelp=substr(($edu_level*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE KEYWORD!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$keyword=$row['cnt'];
			if($total!=0)
				$keywordp=substr(($keyword*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE PHOTOBROWSE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$photobrowse=$row['cnt'];
			if($total!=0)
				$photobrowsep=substr(($photobrowse*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE ONLINE!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$online=$row['cnt'];
			if($total!=0)
				$onlinep=substr(($online*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE FRESHNESS!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$freshness=$row['cnt'];
			if($total!=0)
				$freshnessp=substr(($freshness*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE INCOME!='' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$income=$row['cnt'];
			if($total!=0)
				$incomep=substr(($income*100)/$total,0,5);	
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE LAGE!='0' AND DATE BETWEEN '$st_date' AND '$end_date'";
                        $res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        $row=mysql_fetch_array($res);
                        $age=$row['cnt'];
                        if($total!=0)
                                $agep=substr(($age*100)/$total,0,5);
			$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE LHEIGHT!='0' AND DATE BETWEEN '$st_date' AND '$end_date'";
                        $res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        $row=mysql_fetch_array($res);
                        $height=$row['cnt'];
                        if($total!=0)
		...
		if($field=='gender')
		{ 	$sql="Select count(*) as cnt from MIS.SEARCHQUERY2 WHERE GENDER='M' AND DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
			$row=mysql_fetch_array($res);
			$genderm=$row['cnt'];
			if($total!=0)
		...
		if($field=='mtongue')
		{	
			$sql="select MTONGUE FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        for($i=1;$i<=34;$i++)
				$mvalue[$i]=0; 
		...
		if($field=='caste')
                {
                        $sql="select CASTE FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='occupation')
                {
                        $sql="select OCCUPATION FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='country_res')
                {
                        $sql="select COUNTRY_RES FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='res_status')
                {
                        $sql="select RES_STATUS FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='edu_level')
                {
                        $sql="select EDU_LEVEL FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='income')
                {
                        $sql="select INCOME FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
			...
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                ...
                if($field=='manglik')
                {
                        $sql="select MANGLIK FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='mstatus')
                {
                        $sql="select MSTATUS FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='btype')
                {
                        $sql="select BTYPE  FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='complexion')
                {
                        $sql="select COMPLEXION FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='diet')
                {
                        $sql="select DIET FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='smoke')
                {
                        $sql="select SMOKE FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='drink')
                {
                        $sql="select DRINK FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='handicapped')
                {
                        $sql="select HANDICAPPED FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='children')
                {
                        $sql="select CHILDREN FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='withphoto')
                {
                        $sql="select WITHPHOTO FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		if($field=='age')
		{
			$sql="select LAGE,HAGE FROM  MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        while($row=mysql_fetch_array($res))
		...
		if($field=='height')
                {
                        $sql="select LHEIGHT,HHEIGHT FROM  MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        while($row=mysql_fetch_array($res))
                        {       //if($row['LAGE']!=0 || $row['HAGE']!=0)
		...
		if($field=='city_res')
                {
                        $sql="select CITY_RES FROM MIS.SEARCHQUERY2 WHERE  DATE BETWEEN '$st_date' AND '$end_date'";
			$res=mysql_query_decide($sql,$db) or die("$sql".mysql_error_js($db));
                        //for($i=1;$i<=221;$i++)
                          //      $mvalue[$i]=0;
                        while($row=mysql_fetch_array($res))
		...
		$smarty->display("temp_search_query.htm");
	}
