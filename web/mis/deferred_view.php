...
if(authenticated($cid))
{
	...
	$sql="SELECT DISTINCT SERVICE_STATUS.BILLID,SERVICE_STATUS.SERVICEID,USERNAME,ACTIVATED_ON,EXPIRY_DT from billing.SERVICE_STATUS,billing.PURCHASES where PURCHASES.BILLID=SERVICE_STATUS.BILLID and SERVICE_STATUS.ACTIVATED_ON <= '2005-03-31' and SERVICE_STATUS.ACTIVATED_ON != '0' and SERVICE_STATUS.EXPIRY_DT > '2005-03-31'order by BILLID";
