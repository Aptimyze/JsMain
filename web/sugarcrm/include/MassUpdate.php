...
eoq;
	    ...
	    )
	{
		global $app_strings;
		global $current_user;
		//$current_user->is_exe condition added by Neha
		if(($current_user->is_exe()) || ($this->sugarbean->bean_implements('ACL') && !ACLController::checkAccess($this->sugarbean->module_dir, 'edit', true))){
			return '';
		}
