 ...
 function queryFilterBetween_Dates_old(&$layout_def)
 {
  global $timedate;
	...
	function queryFilterTP_last_month(& $layout_def) {
	    ...
	    $begin=date($GLOBALS['timedate']->get_db_date_time_format(),JSstrToTime("-1 month",mktime(0,0,0,$curr_month,1,$curr_year)));

	    //get end date for last month  and convert it to gmt and db format.
        $end=date($GLOBALS['timedate']->get_db_date_time_format(),JSstrToTime("-1 day",mktime(23,59,59,$curr_month,1,$curr_year)));
		return $this->get_start_end_date_filter($layout_def,$begin,$end);
	}
	...
	function queryFilterTP_next_month(& $layout_def) {
	    ...
	    $begin=date($GLOBALS['timedate']->get_db_date_time_format(),mktime(0,0,0,$curr_month,1,$curr_year));
        $end=date($GLOBALS['timedate']->get_db_date_time_format(),JSstrToTime("-1 day",(JSstrToTime("1 month",mktime(23,59,59,$curr_month,1,$curr_year)))));
