...
$myArray[0]="Please select";
$GLOBALS['app_list_strings']['Height']= $myArray;

unset($myArray);
$myQuery = "select LABEL,VALUE FROM newjs.CITY_NEW WHERE COUNTRY_VALUE='51' AND TYPE!='STATE' ORDER BY SORTBY";
$myResult=$db->query($myQuery);
$myRow= array();
while ($myRow = $db->fetchByAssoc($myResult)) {
$myArray1 [$myRow['VALUE']] = $myRow['LABEL'] ;
}
$myArray1 ['0']='Others';
$GLOBALS['app_list_strings']['City_list']= $myArray1;
?>
