...
function handleRedirect($return_id='', $return_module='')
{
	...
	if(is_array($fileMaxSizeError))
		$fileError="".implode(",",$fileMaxSizeError)."";
    ...
    {
        header("Location: index.php?action=$return_action&module=$return_module&record=$return_id&return_module=$return_module&return_action=$return_action&fileError=$fileError");
    } else {
