...
EOHTML;
	...
	//Changes made by Tanu for css background images
        //$cssFileContents = str_ireplace("entryPoint=getImage&","entryPoint=getImage&themeName={$this->dirName}&",$cssFileContents);
	$cssFileContents = str_ireplace("index.php?entryPoint=getImage&imageName=","themes/Sugar5/images/",$cssFileContents);
