...
$dateDisplayStart	= strftime($timedate->get_user_date_format(), JSstrToTime($date_start));
$dateDisplayEnd   	= strftime($timedate->get_user_date_format(), JSstrToTime($date_end));
$seps				= array("-", "/");
