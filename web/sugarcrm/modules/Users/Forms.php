...
function verify_data(form) 
{
	...
	//Added by Sadaf
	if(document.getElementById('employee_max_cap_c').value)
	{
		var maxCap=trim(document.getElementById('employee_max_cap_c').value);
		if(maxCap && !isNumeric(maxCap))
		{
			alert("Max cap should be numeric!");
			return false;
		}
	}
	//End of addition by Sadaf
	return true;
}
