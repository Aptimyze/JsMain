...
$emailman = new EmailMan();
    ...
    if($test){
        ...
        $select_query.=" AND (em.in_queue ='0' OR ( em.in_queue ='1' AND em.in_queue_date <= " .db_convert("'". gmdate($GLOBALS['timedate']->get_db_date_time_format(), JSstrToTime("-1 day")) ."'" ,"datetime")."))";
        ...
        $select_query.=" AND (in_queue ='0' OR ( in_queue ='1' AND in_queue_date <= " .db_convert("'". gmdate($GLOBALS['timedate']->get_db_date_time_format(), JSstrToTime("-1 day")) ."'" ,"datetime")."))"; 
...
do {
	...
	while(($row = $db->fetchByAssoc($result))!= null){
		...
		$lock_query.=" AND (in_queue ='0' OR ( in_queue ='1' AND in_queue_date <= " .db_convert("'". gmdate($GLOBALS['timedate']->get_db_date_time_format(), JSstrToTime("-1 day")) ."'" ,"datetime")."))"; 
