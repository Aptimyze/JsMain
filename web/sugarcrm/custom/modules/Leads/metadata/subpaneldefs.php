...
{
	$layout_defs['Leads']['subpanel_setup']['history']['collection_list']['notes']['subpanel_name']='ForHistory1';
	$layout_defs['Leads']['subpanel_setup']['history']['collection_list']['meetings']['subpanel_name']='ForHistory1';
	$layout_defs['Leads']['subpanel_setup']['history']['collection_list']['calls']['subpanel_name']='ForHistory1';
	$layout_defs['Leads']['subpanel_setup']['activities']['collection_list']['calls']['subpanel_name']='ForActivities1';
	$layout_defs['Leads']['subpanel_setup']['activities']['collection_list']['meetings']['subpanel_name']='ForActivities1';
}
?>
