...
//Code commented as it displays php compile errors by Neha
//        set_error_handler('handleImportErrors',E_ALL);
        ...
        while ( $row = $importFile->getNextRow() ) {
            ...
            //Enforcing duplicacy check in import module for trac 647 : Changed by sadaf
