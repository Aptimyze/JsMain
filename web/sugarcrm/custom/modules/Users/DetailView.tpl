...
<div id="user_detailview_tabs" class="yui-navset detailview_tabs">
    ...
    <div class="yui-content">
		...
		<tr>
                    <td valign="top" scope="row"><slot>{$MOD.LBL_EMPLOYEE_TYPE}:</slot></td>
                    <td valign="top"><slot>{$EMPLOYEE_TYPE_C}&nbsp;</slot></td>
                    <td valign="top" scope="row"><slot>{$MOD.LBL_EMPLOYEE_MULTI_MTONGUE}:</slot></td>
                    <td valign="top" ><slot>{$EMPLOYEE_MULTI_MTONGUE_C}&nbsp;</slot></td>
                </tr>
		<tr>
                    <td valign="top" scope="row"><slot>{$MOD.LBL_EMPLOYEE_MUTLI_ZONE_C}:</slot></td>
                    <td valign="top"><slot>{$EMPLOYEE_MUTLI_ZONE_C}&nbsp;</slot></td>
                    <td valign="top" scope="row"><slot>{$MOD.LBL_EMPLOYEE_MAX_CAP}:</slot></td>
                    <td valign="top" ><slot>{$EMPLOYEE_MAX_CAP_C}&nbsp;</slot></td>
                </tr>
		<tr>
                    <td valign="top" scope="row"><slot>{$MOD.LBL_EMPLOYEE_OPERATION_MODE_C}:</slot></td>
                    <td valign="top"><slot>{$EMPLOYEE_OPERATION_MODE_C}&nbsp;</slot></td>
