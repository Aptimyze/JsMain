...
//Added by Sadaf for employee form changes
$sugar_smarty->assign('EMPLOYEE_TYPE',$focus->employee_type_c);
$sugar_smarty->assign('EMPLOYEE_MULTI_MTONGUE',$focus->employee_multi_mtongue_c);
$sugar_smarty->assign('EMPLOYEE_MUTLI_ZONE',$focus->employee_mutli_zone_c);
$sugar_smarty->assign('EMPLOYEE_MAX_CAP',$focus->employee_max_cap_c);
//Employee form changes for trac 410
$sugar_smarty->assign('EMPLOYEE_OPERATION_MODE_C',$focus->employee_operation_mode_c);
...
$sugar_smarty->assign('EMPLOYEE_STATUS_OPTIONS', $employee_status);
//Added by Sadaf for employee form changes
$employee_type = '<select tabindex="5" name="employee_type_c">';
$employee_type .= get_select_options_with_id($app_list_strings['employee_type_list'], $focus->employee_type_c);
$employee_type .= '</select>';
$sugar_smarty->assign('EMPLOYEE_TYPE_OPTIONS', $employee_type);
$employee_multi_zone = '<select tabindex="5" name="employee_mutli_zone_c[]" multiple>';
$employee_multi_zone .= get_select_options_with_id($app_list_strings['zone_list'], $focus->employee_mutli_zone_c);
$employee_multi_zone .= '</select>';
$sugar_smarty->assign('EMPLOYEE_MUTLI_ZONE_OPTIONS', $employee_multi_zone);
$employee_multi_mtongue = '<select tabindex="5" name="employee_multi_mtongue_c[]" multiple>';
$employee_multi_mtongue .= get_select_options_with_id($app_list_strings['Mtongue'], $focus->employee_multi_mtongue_c);
$employee_multi_mtongue .= '</select>';
$sugar_smarty->assign('EMPLOYEE_MULTI_MTONGUE_OPTIONS', $employee_multi_mtongue);
$employee_operation_mode = '<select tabindex="5" name="employee_operation_mode_c">';
$employee_operation_mode.= get_select_options_with_id($app_list_strings['employee_operation_mode_list'], $focus->employee_operation_mode_c);
$employee_operation_mode.= '</select>';
$sugar_smarty->assign('EMPLOYEE_OPERATION_MODE_OPTIONS', $employee_operation_mode);
//End of changes added by Sadaf
