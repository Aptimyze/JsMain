...
export default class BasicInfo extends React.Component {
    ...
    showChatOnAppLayer(){
        this.setState({showPromoLayer:true});
    }
    hideChatOnAppLayer(){
    ...
    render() {
      ...
      if(this.props.about.m_status == 'Never Married')
        ...
        if(this.props.onlineInfo){
            ...
            else lastActive= (<span onClick ={this.showChatOnAppLayer.bind(this)} className="f11 color13" id="vpro_last_active" >Online Now</span>);
        }
        let layerHtml = this.state.showPromoLayer ? <ChatLayer /> : <div></div>;
    	return (
...
class ChatLayer extends React.Component{
    ...
    render()
    {
        return (<div id="chatOnAppLayer" className="backoverlayL">
