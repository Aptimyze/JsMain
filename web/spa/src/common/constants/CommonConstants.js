...
export const SPA_PAGE = ['/','/profile/viewprofile.php','/PageNotFound','/login','/myjs','/social/MobilePhotoAlbum','/static/forgotPassword','profile/mainmenu.php','search/topSearchBand','P/logout.php'];
