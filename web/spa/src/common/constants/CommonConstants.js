...
export const LOGGED_OUT_PAGE = ['/profile/viewprofile/','/PageNotFound'];
export const SPA_PAGE = ['/','/profile/viewprofile/','/PageNotFound','/login','/myjs','/social/MobilePhotoAlbum','/static/forgotPassword'];
