    ...
    render() {
        ...
        return (
            <div id="PhotoView" className="posrel">
                ...
                {verifyLayer}
                <div id="picContent">
                    <img id="profilePic" style={{"width":"320px","height":"320px"}} onError={() => this.handleImageError()} onLoad={() => this.handleImageLoaded()} className="vpro_w100Per" src={this.props.picData.url} />
