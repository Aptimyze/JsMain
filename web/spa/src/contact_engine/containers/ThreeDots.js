...
class ThreeDots extends React.Component{
  constructor(props){
    ...
    this.state = {
      ...
      ignoreButton:{},
      tupleDim : {'height': window.innerHeight}
    };
  ...
  render(){
    ...
    //  document.getElementById("vpro_tapoverlay").classList.add("dn");
      ...
      if(this.state.showLoader)
      {
        ...
        return (<div className="posfix ce-bg ce_top1 ce_z106 scrollhid fullwid" id="overlayove_threedot" style={this.state.tupleDim}>
                  <a href="#"  className="ce_overlay ce_z107" > </a>
                    <div className="posabs ce_z108 ce_top1 fullwid" id="overlaysecond_threedot" style={this.state.tupleDim}>
