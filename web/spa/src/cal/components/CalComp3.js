        ...
        {this.state.layerToShow == "loadingScreen" ? <div><Loader show="page"></Loader></div> : null}
          <div style={{backgroundColor: '#09090b',height: this.currentWindowHeight}}>
            ...
            <div id="scrollableDiv" style={{maxHeight: (this.currentWindowHeight-105)+'px',overflowY:'scroll'}}>
              ...
              <input type="number" id={this.calIds['aadhaarNumber']} style={{width: "80%", fontSize: "1.7em", color:'#cccccc', borderBottom: '1px solid',textAlign:'center'}} type="text" placeholder="Aadhaar No." defaultValue={this.savedAadhaarNumber}/>
              ...
              <img src={API_SERVER_CONSTANTS.STATIC_SERVER+"/images/jspc/myjsImg/pencil.png"} className="pos-abs" style={{cursor: "pointer",right:"9px",top:"5px"}} />
