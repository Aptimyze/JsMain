...
//JPROFILE
$j = new JPROFILE();
//$x  = $j->get("144111","PROFILEID","*",array("activatedKey"=>1));
...
//$x  = $j->getProfileEducation("144111");
...
//$x = $j->commonFunctionForSelect("144111","*");
$x = $j->getAllSubscriptionsArr(array("9474668","144111"));
//print_r($x);die;
/********************DONE**************************/
