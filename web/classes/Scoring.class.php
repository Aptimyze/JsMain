	...
	*/
	public function setAllAttributeParameters($scorevars,$myDb)
	{
		...
		$sql3="SELECT SQL_CACHE ComZone FROM scoring.community_zone WHERE Community='$com'";
                $result3 = mysql_query_decide($sql3,$myDb) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($myDb)));
	...
	public function __construct($scorevars,$myDb,$shDb)
        ...
        */
		...
		$sql3 = "SELECT MAX(PAGE) AS PAGE FROM  billing.PAYMENT_HITS WHERE PROFILEID='$pid' AND ENTRY_DT BETWEEN '$lim_7_dt' AND '$cut_off'";
                $res3 = mysql_query_decide($sql3,$myDb) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($myDb)));
                ...
                $res4 = mysql_query_decide($sql4,$myDb) or LoggingWrapper::getInstance()->sendLog(LoggingEnums::LOG_ERROR, new Exception(mysql_error($myDb)));
