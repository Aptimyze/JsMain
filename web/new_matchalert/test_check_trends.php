...
if($this_script==0)
{
        ...
        $sql_loop="SELECT A.PROFILEID,GENDER FROM matchalerts.JPARTNER A LEFT JOIN PROFILE_LOGS B ON A.PROFILEID=B.PROFILEID WHERE B.PROFILEID IS NULL AND A.PROFILEID%$total_scripts=$this_script LIMIT 1";
