...
function ReverseContentDisplay(d,latitude,longitude) 
{
	...
	{ 
		...
		initLoader();
		if(document.getElementById("notexter"))
			document.getElementById("lynj").style.display='none';
		document.getElementById(d).style.display = "block"; 
	}
	else 
	{
		...
		if(document.getElementById("notexter"))
			document.getElementById("lynj").style.display='inline';
		document.getElementById(d).style.display = "none"; 
	}
}
...
function listener( e,top )
{
	...
	if(virtual_top>230)
	{
			...
			document.getElementById("left_arrow").style.display ="block";
               		top_pos= mousey-185; //e.clientY-120;
               		left_position=e.clientX+84;
       		}
       		else if(top=='r')
       		{
