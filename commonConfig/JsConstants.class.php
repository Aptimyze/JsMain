...
public static $all =
	[
		...
		"matchAlertsCommunityModelApi" => "http://10.10.18.87:2233/commModelRecommendations_live",
...
public static $dev = 
	[
		...
		"chatListingWebServiceUrl" => 'array("dpp"=>"%URL_INPUT%:8190/listings/v1/discover","shortlist"=>"http://%URL_INPUT%:8190/listings/v1/activities","chatAuth"=>"http://%URL_INPUT%:8390/auth/v1/chat","rosterRemoveMsg"=>"http://%URL_INPUT%:8490/communication/v1/message")',
