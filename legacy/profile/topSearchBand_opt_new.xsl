...
<xsl:template match="/registrationPage1">
		...
		<xsl:variable name="casteVal" select="checkParams/casteVal" />
			...
			<div class="q_search sprte m_t_b_10">
				<div class="l_search sprte fl"></div>
				<div style="float:left; padding:4px 0 4px 23px;">

					<div class="fl mt_10">	
                                                <select name="Gender" class="w_153" onchange="set_default_age_range(lage,hage);">
                                                        <option value="F" >
						...
						<br />	
	                			<select class="w_69 mt_4" name="lage" id="lageId">
							<xsl:for-each select="populate/ageshow">
								...
								<xsl:choose>
									...
									<xsl:otherwise>
	                                        ...
	                                        <select class="w_69 mt_4" name="hage">
	                                                <xsl:for-each select="populate/ageshow">
					...
					<div class="fl mt_10 ml_17" style="width:200px;">
					...
					<div class="fl mt_4"> <br />
						<input type="submit" id="searchButton" name="Search" value="" class="s_btn sprte fl" style="cursor:pointer;border:0pt none;" />
						<input type="hidden" name="Search" value="" />
					</div>
					</div>
					<div class="r_search sprte fr"></div>
			</div>
