...
<xsl:template match="/registrationPage1">
		<form name="search_partner" style="margin:0px;padding:0px" action="/search/perform" method="post" target="_parent" onsubmit="return checkData();">	
			...
			<div class="q_search">
				<div class="l_search fl"></div>
					<div class="fl mt_10 mt_10">	
                                                <select name="Gender" style="width:120px;" onchange="set_default_age_range(lage,hage);" class="w_118">
                                                        <option value="F" >
					...
					<div style="margin-left: 17px; width: 198px; float: left;" class="fl mt_10">
						...
						<p class="clr" style="margin-bottom:5px;"></p>
                			...
                			<div class="fl" style="margin: 21px 0pt 0pt 5px;" >
                				<input type="submit" name="Search" value="" class="s_btn fl" style="border:0;" />	
