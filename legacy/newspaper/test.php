...
while($row=mysql_fetch_array($res))
{
	...
	echo $sql_update = "UPDATE AFFILIATE_DATA SET EMAIL='$email' WHERE PROFILEID='$pid'";
	//mysql_query($sql_update) or die("$sql_update".mysql_error());

	echo $mailsql = "INSERT IGNORE INTO jsadmin.AFFILIATE_MAIN (SOURCE , EMAIL , MODE , ENTRYBY , ENTRYTIME) values ('afl_rishta', '$email','N','anita',NOW())";
