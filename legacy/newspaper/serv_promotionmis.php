<?php
/****************************************************************************************************************************
*	FILENAME	   : serv_promotionmis.php
*	INCLUDED           : connect.inc.
*       DESCRIPTION        : Displays the details of the promotions via SMS or Newspaper month and day wise depending upon 
			     the users choice.
****************************************************************************************************************************/
	//	include("newsprom_comfunc.inc");
	        ...
	        if($submit)
		{
			...
			$sql = "SELECT USERNAME FROM jsadmin.PSWRDS WHERE PRIVILAGE LIKE '%NP%' OR PRIVILAGE LIKE '%AFFP%' ";
			...
			if($criteria == 'D')
			{
				...
				$sql.=" AND MODE IN ('N','S') GROUP BY ENTRYBY , dd , MODE ";                                                                $res = mysql_query($sql,$db) or die("$sql".mysql_error());
				...
				while ($conv_row = mysql_fetch_array($conv_res))
                        ...
                        $smarty->assign("totmodecount",$totmodecount);                                                                               $smarty->assign("mmcount2",$mmcount2);
			...
			$smarty->assign("dmonth",$dmonth);
                        ...
                        $smarty->display("serv_promotionmis.htm");
