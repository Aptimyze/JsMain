<?php
	...
	$val1 = shell_exec("/usr/local/mysql/bin/mysqldump -u root --password=Km7Iv80l -t  --where='CURDATE()<=ENTRYTIME AND ENTRYTIME<>0000-00-00 ' jsadmin AFFILIATE_MAIN > mailerdump.txt");
	...
	$val2 = shell_exec("/usr/local/mysql/bin/mysqldump -u root --password=Km7Iv80l -t  --where='CURDATE()<=ENTRY_DT AND ENTRY_DT<>0000-00-00 ' jsadmin AFFILIATE_DATA >> mailerdump.txt");
