...
<br>
<br>
<form action="revenue_date.php" method="post">
...
~else`
	...
	~if $flag_type eq 'Y'`
	~foreach name=outer key=loc item=rows from=$reven`
	<tr class= "label">
	...
	~/foreach`
	<tr class="label">
        <td align="center">&nbsp;Offline Revenue</td>
                ~foreach from=$monthDaysArray item=v`
        <td align="center" width=6% >&nbsp;~$reven[$v]`</td>
                        ~/foreach`
         <td align="center">&nbsp;~$total`</td>
         </tr>
        <tr class="label">
        <td align="center">&nbsp;Offline Billing Revenue</td>
                ~foreach from=$monthDaysArray item=v`
        <td align="center" width=6% >&nbsp;~$reven2[$v]`</td>
                        ~/foreach`
         <td align="center">&nbsp;~$total2`</td>
         </tr>
	<tr class= "label">
	<td align="center">&nbsp;Total without Tax</td>
    	~foreach name=tot from=$monthDaysArray item=v`
	<td align="center" width=6% >&nbsp;~$tot_d_notax[$v]`</td>
      		~/foreach`
	<td align="center" width=6% >&nbsp;~$tot_notax`</td>
        </tr>
	<tr class= "label">
	<td align="center">&nbsp;Total</td>
    	~foreach name=tot from=$monthDaysArray item=v`
	...
	<tr class="label">
        <td align="center">&nbsp;Offline Billing Revenue</td>
                ~foreach from=$monthDaysArray item=v`
        <td align="center" width=6% >&nbsp;~$data2[$v]`</td>
                        ~/foreach`
         <td align="center">&nbsp;~$total2`</td>
         </tr>
	<tr class= "label">
        <td align="center">&nbsp;Total without Tax</td>
        ~foreach name=tot from=$monthDaysArray item=v`
        <td align="center" width=6% >&nbsp;~$data_notax[$v]`</td>
                ~/foreach`
        <td align="center" width=6% >&nbsp;~$total_notax`</td>
        </tr>
	~/if`
