...
//$sql_rel_caste="select PROFILEID,PARTNER_CASTE FROM SEARCH_MALE_REV WHERE PARTNER_CASTE<>''";
//$sql_rel_caste="select PROFILEID,PARTNER_CASTE,PARTNER_MTONGUE,PARTNER_MSTATUS,PARTNER_COUNTRYRES FROM SEARCH_MALE_REV WHERE BUCKET=0 AND PROFILEID%3>0";
$sql_rel_caste="select PROFILEID,PARTNER_CASTE,PARTNER_MTONGUE,PARTNER_MSTATUS,PARTNER_COUNTRYRES FROM SEARCH_MALE_REV";
...
while($myrow_sql_rel_caste_result=mysql_fetch_array($sql_rel_caste_result))
{
	...
	$sql="UPDATE SEARCH_MALE_REV SET BUCKET='$Tscore' WHERE PROFILEID=$pid";
