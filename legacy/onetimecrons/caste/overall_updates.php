...
$filename = "old_caste_mtongue_mapping.csv";    //This filename to be used for mapping of old caste values to mtongues
...
update_caste_mtongue_mapping1($old_value,$new_value,"CASTE_COMMUNITY_TOP_BAND","CASTE","newjs","MTONGUE",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "CASTE_COMMUNITY_TOP_BAND MAPPING DONE \n";
update_caste_mtongue_mapping1($old_value,$new_value,"CASTE_COMMUNITY_TOP_BAND","HINDU_CASTE","newjs","MTONGUE",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "CASTE_COMMUNITY_TOP_BAND MAPPING DONE \n";
...
//trends update
trends_update($old_value,$new_value,"CASTE_FEMALE_PERCENT","PERCENT","twowaymatch","CASTE",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "twowaymatch|CASTE_FEMALE_PERCENT|CASTE|CASTE \n";
trends_update($old_value,$new_value,"CASTE_MALE_PERCENT","PERCENT","twowaymatch","CASTE",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "twowaymatch|CASTE_MALE_PERCENT|CASTE|CASTE \n";
...
unset($old_value);
unset($new_value);
$filename = "new_caste_mtongue_mapping.csv";	//This filename to be used for mapping of new caste values to mtongues
$data = read_file($filename);
foreach ($data as $k=>$v)
{
 	$values = explode("|",trim($v));
...
update_caste_mtongue_mapping($old_value,$new_value,"CASTE_COMMUNITY_TOP_BAND","CASTE","newjs","ID",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "CASTE_COMMUNITY_TOP_BAND MAPPING DONE \n";
update_caste_mtongue_mapping($old_value,$new_value,"CASTE_COMMUNITY_TOP_BAND","HINDU_CASTE","newjs","ID",$mysqlObjM,$mysqlObjS,$dbM,$dbS);
echo "CASTE_COMMUNITY_TOP_BAND MAPPING DONE \n";
