<?php
/*********************************************************************************************
* FILE NAME     : businesssathi_faqs.php
* DESCRIPTION   : Displays Business Sathi FAQ page after putting Head and Left panel in place
...
if(isset($data))
{
	$smarty->display("business_sathi/businesssathi_faqs.htm");
}
else
{
	$smarty->display("business_sathi/businesssathi_faqs.htm");
