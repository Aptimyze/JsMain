<?php
/*********************************************************************************************
* FILE NAME     : businesssathi_tariff.php
* DESCRIPTION   : Displays Business Sathi Tariff page after putting Head and Left panels in place
...
if(isset($data))
{
	$smarty->display("business_sathi/businesssathi_tariff.htm");
}
else
{
        $smarty->display("business_sathi/businesssathi_tariff.htm");
