<?php
/*********************************************************************************************
* FILE NAME     : businesssathi_terms.php
* DESCRIPTION   : Displays Business Sathi Terms page after putting Head and Left panels in place
...
if(isset($data))
{
	$smarty->display("business_sathi/businesssathi_terms.htm");
}
else
{
        $smarty->display("business_sathi/businesssathi_terms.htm");
