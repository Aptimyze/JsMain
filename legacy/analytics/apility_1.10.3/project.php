...
?>
 ...
 <table border="1">
  ...
  <tr><td><pre>$campaign->getDailyBudget();</pre></td><td><?php echo $campaign->getDailyBudget(); ?></td></tr>
 ...
 <table border="1">
  ...
  <tr><td><pre>$adGroup->getMaxCpc();</pre></td><td><?php echo $adGroup->getMaxCpc(); ?></td></tr>
 ...
 <table border="1">
  <tr><th>Method Call</th><th>Return Value</th></tr>
  <tr><td><pre><?php if (strcasecmp($criterion->getCriterionType(), "Keyword") == 0) echo "\$criterion->getText();"; else echo "\$criterion->getUrl();" ?></pre></td><td><?php if (strcasecmp($criterion->getCriterionType(), "Keyword") == 0) echo $criterion->getText(); else echo $criterion->getUrl(); ?></td></tr>
