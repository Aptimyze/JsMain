...
mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Google Adwords 99acres Report Done for ".$date," Overall Consumed Units: ".$soapClients->getOverallConsumedUnits()." \n Overall Performed Operations: ".$soapClients->getOverallPerformedOperations());


function mysql_error1($db,$sql)
{
        mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Error in Google Adwords 99acres Report",mysql_error($db)." ".$sql);
}
