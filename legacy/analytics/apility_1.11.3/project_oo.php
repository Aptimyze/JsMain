...
<?php
  ...
  $allCampaigns = $apilityUser->getAllCampaigns();
...
?>
 ...
 <pre><?php echo removeTags(highlight_string('<?php $allCampaigns = $apilityUser->getAllCampaigns(); ?>', true)); ?></pre>
 ...
 <table border="1">
  ...
  <tr><td><pre><?php echo removeTags(highlight_string('<?php $campaign->getDailyBudget(); ?>', true)); ?></pre></td><td><?php echo $campaign->getDailyBudget(); ?></td></tr>
 ...
 <pre><?php echo removeTags(highlight_string('<?php $adGroups = $campaign->getAllAdGroups(); ?>', true)); ?></pre><br />
