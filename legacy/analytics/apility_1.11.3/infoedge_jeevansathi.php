...
// it takes around 35 lakh units to get static data for all accouts 4 jeevansathi, 5 naukri , 2 99acres
...
mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Google Adwords Jeevansathi One Time Data Fetch Done ".date('Y-m-d')," Overall Consumed Units: ".$soapClients->getOverallConsumedUnits()." \n Overall Performed Operations: ".$soapClients->getOverallPerformedOperations()." Time taken in hours ".$time);
...
{
        mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Error in Google Adwords Jeevansathi One Time Data Fetch ",mysql_error($db)." ".$sql);
}
