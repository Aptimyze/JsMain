...
mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Google Adwords 99acres One Time Data Fetch Done ".date('Y-m-d')," Overall Consumed Units: ".$soapClients->getOverallConsumedUnits()." \n Overall Performed Operations: ".$soapClients->getOverallPerformedOperations()." Time taken in hours ".$time);
...
{
        mail("puneet.makkar@jeevansathi.com,neha.verma@jeevansathi.com","Error in Google Adwords 99acres One Time Data Fetch ",mysql_error($db)." ".$sql);
}
