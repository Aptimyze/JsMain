  ...
  class APIlityClients {
    ...
    function getLastSoapRequests() {
      if (strcmp(DISPLAY_ERROR_STYLE, "HTML") == 0) {
        $style = "<style type='text/css'> .string { font-family:monospace;
    ...
    function setSoapHeaders($authenticationContext) {
      $this->soapHeader = $authenticationContext->getHeader();
