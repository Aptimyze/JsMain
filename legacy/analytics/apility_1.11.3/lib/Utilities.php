<?php
  ...
  function checkApilityRequirements() {
    ...
    else $errorMessage .= "<br /><b>APIlity PHP library => Warning:</b><br /> APIlity requires <b>cURL</b>. Please make sure it is installed. <a href='http://google-apility.sourceforge.net/index.html#Requirements' target='_blank'>Instructions</a> here.<br />This warning can be ignored if you do not need any of the <b>Report functionalities</b>.";

    // PHP version is < 5, check if DOM_XML exists
    if (version_compare(phpversion(), "5.0.0", "<"))  {
      if (!function_exists("domxml_open_mem")) {
        $requirementsFulfilled = false;
        $errorMessage .= "<br /><b>APIlity PHP library => Warning:</b><br />APIlity requires <b>DOM XML</b> when you are running PHP4.x. Please make sure it is installed. <a href='http://google-apility.sourceforge.net/index.html#Requirements' target='_blank'>Instructions</a> here.<br />This warning can be ignored if you do not need any of the <b>Report functionalities</b>.";
      }
    }
    return array(
  ...
  function img2base64($fileName) {
    if (file_exists($fileName)) {
      ...
      if (!SILENCE_STEALTH_MODE) echo '<br /><b>APIlity PHP library => Warning:</b><br />Sorry, but the specified file '.addslashes($fileName).' does not exist.';
      return false;
    }
  }
