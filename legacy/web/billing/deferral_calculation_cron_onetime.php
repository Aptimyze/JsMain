...
$sql="SELECT DISTINCT(BILLID) FROM billing.PAYMENT_DETAIL WHERE DEFERRAL_FLAG='N' AND BILLID >=$i AND BILLID <$j";
...
$sql="UPDATE billing.PAYMENT_DETAIL SET DEFERRAL_FLAG='Y' WHERE BILLID IN ($billid_str)";
