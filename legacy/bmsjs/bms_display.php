...
***************************************************************************************************************************/
mail("lavesh.rawat@jeevansathi.com,lavesh.rawat@gmail.com","file used:bms_display.php","bms","info@jeevansathi.com");
  ...
  function actual_display($finlist,$bannarr,$zonearr,$zone)
  {
  	...
  	$align=$zonearr[$zone]["align"];
    	...
    	if($zone!=$_LogosZone)
    	{
    		if($ispopup!='Y')
    		{
    			$echostr="<Table border=0 cellpadding=0 cellspacing=0>";
...
//						echo "<br>"."TEMP : ";print_r($temp);echo "<br>";
			...
			if(in_array("LOCATION",$zonecritarr))
			{
				if($bannarr[$banner]["location"] && trim($bannarr[$banner]["location"])!='')
						...
						if ($locationcity == 1 || $locationcity == 0)
