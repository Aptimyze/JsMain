...
//        $email  = "darshan@jeevansathi.com,lavesh.rawat@jeevansathi.com,alok@jeevansathi.com,ankita.malik@naukri.com,lijuv@naukri.com,Divya.richa@naukri.com,ankit.bhatnagar@naukri.com,siddharth.chaturvedi@naukri.com,asif.ghani@naukri.com,shwetaa.kapoor@naukri.com";
	$email="asif.ghani@naukri.com,lavesh.rawat@jeevansathi.com,lijuv@naukri.com";

        $db = @mysql_connect(MysqlDbConstants::$bms['HOST'].":".MysqlDbConstants::$bms['PORT'],MysqlDbConstants::$bms['USER'],MysqlDbConstants::$bms['PASS']) or die("Can't connect to Database".mysql_error());
	...
	$message.="</table>";
	$subject = "Campaign MIS for JS:".$prevdate;
