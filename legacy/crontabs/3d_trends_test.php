...
//		$res_main=$mysqlObj->executeQuery($sql,$myDb);
	...
	//	{
			...
			if($my_income[$i]==15)
				$my_income[$i]=0;
			elseif($my_income[$i]==1)
                                $my_income[$i]=1;
			elseif($my_income[$i]==2)
				$my_income[$i]=2;
			elseif($my_income[$i]==3)
				$my_income[$i]=3;
			elseif($my_income[$i]==4)
				$my_income[$i]=4;
			elseif($my_income[$i]==8)
				$my_income[$i]=5;
			elseif($my_income[$i]==5)
				$my_income[$i]=6;
			elseif($my_income[$i]==6)
				$my_income[$i]=7;
			...
			elseif($my_income[$i]==13)
                                $my_income[$i]=15;
			elseif($my_income[$i]==20)
                                $my_income[$i]=16;
			elseif($my_income[$i]==22)
                                $my_income[$i]=17;
			elseif($my_income[$i]==21)
                                $my_income[$i]=18;
			elseif($my_income[$i]==23)
                                $my_income[$i]=19;
			...
			if( is_array($income) && count($income)>0 )
			{
				...
				echo "income_field--->";print_r($income_field);
die;
				$income_count=0;
				...
				if($income_value_percentile_string=='|')
					$income_value_percentile_string='';
				echo "income_value_percentile_string---$income_value_percentile_string";
			}
			...
			//if($self_initiated || $self_accepted)
		//	{
	...
	$time_end = microtime_float();
        ...
        mail("ankit.aggarwal@jeevansathi.com","Trends table filled up in $time hours ".date('Y-m-d'),date('Y-m-d')." records inserted ".$records);
