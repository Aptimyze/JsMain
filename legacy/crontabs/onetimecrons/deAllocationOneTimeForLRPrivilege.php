...
$processName 	='HOTFIX_786';
$deAllocatedBy	='SYSTEM';

$agentArr =array('chandra.t','abhishek.b','anjana.yadav','khem.chand','niyaz.ahmed','ranjan.kumar','shobha.kujur','ajay.y','akshay.chauhan','akul.rai','ashutosh.o','ashutosh.u','chandan.kumar','deepika.awasthi','deepmala.a','himanshu.nowal','leena.thomas','manju.singh','neha.p','richa.kumari','ritesh.gupta','sushil.kumar','tripti.upadhayay','vaishali.gupta','vineet.kaur');
