...
if(1)
{
	...
	//To test script, enter profileid's in this array
	$profileArray=array(4915271);
	
	foreach($profileArray as $key=>$id)
	{
		$records=0;
		/*if($table[$t]=='SEARCH_FEMALE')
			...
			$gender='FEMALE';*/
		$myDbName=getProfileDatabaseConnectionName($id,'slave',$mysqlObj);
		...
		echo "mstatus max deviation  ".$mstatus_max_deviation;
...
$mstatus_max_deviation=40.00;
echo "---";
echo $mstatus_max_deviation/$total_deviation;
echo "---";
