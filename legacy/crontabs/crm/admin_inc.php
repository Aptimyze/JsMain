...
$follow_date= time_day($tdate,7);

$sql="SELECT PROFILEID, CITY_RES,PHONE_RES,PHONE_MOB, incentive.BRANCH_CITY.NEAR_BRANCH from newjs.JPROFILE, incentive.BRANCH_CITY where ENTRY_DT between '$tdate 00:00:00' and '$tdate 23:59:59' and newjs.JPROFILE.CITY_RES=incentive.BRANCH_CITY.VALUE and incentive.BRANCH_CITY.NEAR_BRANCH NOT IN ('','UP25') order by GENDER,AGE"; 
