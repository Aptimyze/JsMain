<?php 
 ...
 include_once("/usr/local/scripts/DocRoot.php");
	...
	$header="\"PROFILEID\"".","."\"PHONE_NO1\"".","."\"PHONE_NO2\"".","."\"CITY\"".","."\"PHOTO\"".","."\"CONTACTS_INITIATED\"".","."\"CONTACTS_ACCEPTED\"".","."\"CONTACTS_RECEIVED\"".","."\"ACCEPTANCE_RECEIVED\"".","."\"AGE\"".","."\"POSTEDBY\"".","."\"GENDER\"".","."\"CASTE\"".","."\"COMMUNITY\"".","."\"PROFILELENGTH\"".","."\"DESIRED_PARTNER_PROFILE\"".","."\"LAST_LOGIN_DATE\"".","."\"SCORE\"".","."\"PROFILE_AGE\"".","."\"MSTATUS\"".","."\"INCOME\"".","."\"LEAD_ID\"".","."\"PHONE_1\"".","."\"PHONE_2\"".","."\"DIAL_STATUS\"".","."\"PRIORITY\"\n";
	...
	$sql="insert into incentive.TEMP_CSV_PROFILES (PROFILEID, SCORE, MTONGUE) select PROFILEID, SCORE, MTONGUE from incentive.MAIN_ADMIN_POOL WHERE SCORE >= 250 AND ALLOTMENT_AVAIL='Y' AND TIMES_TRIED<3 AND MTONGUE <> '1'";
