	...
	function write_contents_to_file($profileid,$mtongue="",$score="",$failed_payments="",$DPP=0,$extra_params="")
	{
		...
		if ($row = mysql_fetch_array($res))
		{
			...
			if((trim($PHONE_RES) || trim($PHONE_MOB)))
			{
				...
				{
					$line="\"$profileid\"".","."\"$PHONE_MOB\"".","."\"$PHONE_RES\"".","."\"$CITY_RES $EVER_PAID1\"".","."\"$PHOTO1 $status\"".","."\"$INITIATE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$RECEIVE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$DOB\"".","."\"$POSTEDBY\"".","."\"$GENDER\"".","."\"$CASTE\"".","."\"$MTONGUE\"".","."\"$PROFILELENGTH\"".","."\"$HAVEPARTNER\"".","."\"$LAST_LOGIN_DT\"".","."\"$score\"".","."\"$ENTRY_DT\"";
				}
				elseif ($PHONE_MOB && $PHONE_RES =='')
				{
					$line="\"$profileid\"".","."\"$PHONE_MOB\"".",\"\","."\"$CITY_RES $EVER_PAID1\"".","."\"$PHOTO1 $status\"".","."\"$INITIATE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$RECEIVE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$DOB\"".","."\"$POSTEDBY\"".","."\"$GENDER\"".","."\"$CASTE\"".","."\"$MTONGUE\"".","."\"$PROFILELENGTH\"".","."\"$HAVEPARTNER\"".","."\"$LAST_LOGIN_DT\"".","."\"$score\"".","."\"$ENTRY_DT\"";
				}
				elseif ($PHONE_MOB =='' && $PHONE_RES)
				{
					$line="\"$profileid\"".","."\"$PHONE_RES\"".",\"\","."\"$CITY_RES $EVER_PAID1\"".","."\"$PHOTO1 $status\"".","."\"$INITIATE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$RECEIVE_CNT\"".","."\"$TOTAL_ACCEPTANCE\"".","."\"$DOB\"".","."\"$POSTEDBY\"".","."\"$GENDER\"".","."\"$CASTE\"".","."\"$MTONGUE\"".","."\"$PROFILELENGTH\"".","."\"$HAVEPARTNER\"".","."\"$LAST_LOGIN_DT\"".","."\"$score\"".","."\"$ENTRY_DT\"";
				}
