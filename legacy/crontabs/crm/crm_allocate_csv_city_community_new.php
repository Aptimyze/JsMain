<?php 
 ...
 include_once("/usr/local/scripts/DocRoot.php");
	...
	$header="\"PROFILEID\"".","."\"PHONE_NO1\"".","."\"PHONE_NO2\"".","."\"CITY\"".","."\"PHOTO\"".","."\"CONTACTS_INITIATED\"".","."\"CONTACTS_ACCEPTED\"".","."\"CONTACTS_RECEIVED\"".","."\"ACCEPTANCE_RECEIVED\"".","."\"DATE_OF_BIRTH\"".","."\"POSTEDBY\"".","."\"GENDER\"".","."\"CASTE\"".","."\"COMMUNITY\"".","."\"PROFILELENGTH\"".","."\"DESIRED_PARTNER_PROFILE\"".","."\"LAST_LOGIN_DATE\"".","."\"SCORE\"".","."\"ENTRY_DATE\"".","."\"LEAD_ID\"".","."\"PHONE_1\"".","."\"PHONE_2\"".","."\"DIAL_STATUS\"".","."\"PRIORITY\"\n";
