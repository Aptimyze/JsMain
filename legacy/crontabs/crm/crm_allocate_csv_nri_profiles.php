...
include_once("/usr/local/scripts/DocRoot.php");
	...
	$header="\"PROFILEID\"".","."\"PHONE NO.(1)\"".","."\"PHONE NO.(2)\"".","."\"COUNTRY\"".","."\"PHOTO\"".","."\"CONTACTS INITIATED\"".","."\"CONTACTS ACCEPTED\"".","."\"CONTACTS RECEIVED\"".","."\"ACCEPTANCE RECEIVED\"".","."\"DATE OF BIRTH\"".","."\"POSTEDBY\"".","."\"GENDER\"".","."\"CASTE\"".","."\"COMMUNITY\"".","."\"PROFILELENGTH\"".","."\"DESIRED PARTNER PROFILE\"".","."\"LAST LOGIN DATE\"".","."\"SCORE\"".","."\"ENTRY_DATE\"".","."\"EVER_PAID\"\n";
        ...
        $filename = "$_SERVER[DOCUMENT_ROOT]/crm/csv_files/bulk_csv_crm_data_".date('Y-m-d')."_nri.txt";
	...
	$sqlj="SELECT PROFILEID FROM newjs.JPROFILE WHERE SUBSCRIPTION = '' AND ACTIVATED IN ('Y', 'H') AND INCOMPLETE = 'N' AND LAST_LOGIN_DT >= DATE_SUB( CURDATE( ) , INTERVAL 45 DAY ) AND ENTRY_DT < DATE_SUB( CURDATE( ) , INTERVAL 1 DAY ) AND COUNTRY_RES IN ($nri_str)";
	...
	$profileid_file = $SITE_URL."/crm/csv_files/bulk_csv_crm_data_".date('Y-m-d')."_nri.txt";

	$msg="For NRI Profiles: ".$profileid_file;

	$to="anamika.singh@jeevansathi.com,nitika.bhatia@jeevansathi.com,princy.gulati@jeevansathi.com,anjali.singh@jeevansathi.com,shafali.kataria@jeevansathi.com,samrat.chadha@naukri.com,nidhi.aneja@jeevansathi.com";
	$bcc="vibhor.garg@jeevansathi.com";
	$sub="Daily CSV for NRI profiles";
