...
import org.jivesoftware.smack.packet.DefaultPacketExtension;
 ...
 public  class MessageParrot implements PacketListener {
	...
	//DefaultPacketExtension vcardExtension =(DefaultPacketExtension)message.getExtension("firstmes","jabber:client");
	//vcardExtension.getValue("firstmes");
	//System.out.println(vcardExtension.toXML());	
//	System.out.println("first"+packet.getExtension(vcardExtension)+"second");
//	System.out.println(message.toXML());
//	String arg=message.getXmlns();
//	System.out.println("nikhil"+arg+"dhiman");
	//DefaultPacketExtension de=(DefaultPacketExtension)packet;
           ...
           if(message.getBody() != null ) {
			...
			//System.out.println(message.toXML());
				...
				if(chattingWith!=null)
				{
            		...
            		}else{//this block of code for msg coming from gtalk user.
            		...
            		System.out.println(isUserExit+msg+isCommand);	
            			if(isUserExit == true && !msg.equals("@end") && !msg.equals("@yes") && !msg.equals("@no")){
        					...
        					if(toWhom !=null && to!=null){
            					System.out.println("to whom"+toWhom+" to"+to+" profileid"+profileID1+"msgpacket"+msgPacket);
            			...
            			/*else if(msg.equals("@hide") ||  msg.equals("@show")){
            				
            				 try {
            					 	pst = GtalkBot.conn.prepareStatement("update customer set hide_show=? where cust_email =?");
            					 	if(msg.equals("@hide")){
            					 		//pst.setString(1, 1);
            					 		pst.setInt(1, 1);//this is for hiding the user fro search
            					 	}else{
            					 		pst.setInt(1, 0);//this is for enable the user to be in the search page
            					 	}
            						pst.setString(2, msgFrom);
            			            pst.executeUpdate();
